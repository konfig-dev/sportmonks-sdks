...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeagueByIdResponse_rate_limit")]
    public partial class SportLeagueByIdResponseRateLimit : IEquatable<SportLeagueByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeagueByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportLeagueByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeagueByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportLeagueByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportLeagueByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeagueByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeagueByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
