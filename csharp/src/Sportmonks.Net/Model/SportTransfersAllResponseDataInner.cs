...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTransfersAllResponse_data_inner")]
    public partial class SportTransfersAllResponseDataInner : IEquatable<SportTransfersAllResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTransfersAllResponseDataInner" /> class.
        /// </summary>
        ...
        public SportTransfersAllResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal playerId = default(decimal), decimal typeId = default(decimal), decimal fromTeamId = default(decimal), decimal toTeamId = default(decimal), decimal positionId = default(decimal), decimal detailedPositionId = default(decimal), string date = default(string), bool careerEnded = default(bool), bool completed = default(bool), string completedAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTransfersAllResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportTransfersAllResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportTransfersAllResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTransfersAllResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTransfersAllResponseDataInner input)
        {
            if (input == null)
            {
                return false;
