...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixturesHeadToHeadResponse_rate_limit")]
    public partial class SportFixturesHeadToHeadResponseRateLimit : IEquatable<SportFixturesHeadToHeadResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixturesHeadToHeadResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportFixturesHeadToHeadResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixturesHeadToHeadResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportFixturesHeadToHeadResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportFixturesHeadToHeadResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixturesHeadToHeadResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixturesHeadToHeadResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
