...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesBySeasonIdResponse_data_inner_rounds_inner")]
    public partial class SportSchedulesBySeasonIdResponseDataInnerRoundsInner : IEquatable<SportSchedulesBySeasonIdResponseDataInnerRoundsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesBySeasonIdResponseDataInnerRoundsInner" /> class.
        /// </summary>
        ...
        public SportSchedulesBySeasonIdResponseDataInnerRoundsInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal leagueId = default(decimal), decimal seasonId = default(decimal), decimal stageId = default(decimal), string name = default(string), bool finished = default(bool), bool isCurrent = default(bool), string startingAt = default(string), string endingAt = default(string), List<SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner> fixtures = default(List<SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner>))
        {
            this.Id = id;
        ...
        public List<SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner> Fixtures { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesBySeasonIdResponseDataInnerRoundsInner {\n");
        ...
        {
            return this.Equals(input as SportSchedulesBySeasonIdResponseDataInnerRoundsInner);
        }

        /// <summary>
        /// Returns true if SportSchedulesBySeasonIdResponseDataInnerRoundsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesBySeasonIdResponseDataInnerRoundsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesBySeasonIdResponseDataInnerRoundsInner input)
        {
            if (input == null)
            {
                return false;
