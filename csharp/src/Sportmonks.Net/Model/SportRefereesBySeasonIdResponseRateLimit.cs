...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRefereesBySeasonIdResponse_rate_limit")]
    public partial class SportRefereesBySeasonIdResponseRateLimit : IEquatable<SportRefereesBySeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRefereesBySeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportRefereesBySeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRefereesBySeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportRefereesBySeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportRefereesBySeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRefereesBySeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRefereesBySeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
