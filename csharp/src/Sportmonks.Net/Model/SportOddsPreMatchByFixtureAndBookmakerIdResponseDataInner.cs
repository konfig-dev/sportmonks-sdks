...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportOddsPreMatchByFixtureAndBookmakerIdResponse_data_inner")]
    public partial class SportOddsPreMatchByFixtureAndBookmakerIdResponseDataInner : IEquatable<SportOddsPreMatchByFixtureAndBookmakerIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportOddsPreMatchByFixtureAndBookmakerIdResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportOddsPreMatchByFixtureAndBookmakerIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportOddsPreMatchByFixtureAndBookmakerIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportOddsPreMatchByFixtureAndBookmakerIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportOddsPreMatchByFixtureAndBookmakerIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportOddsPreMatchByFixtureAndBookmakerIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
