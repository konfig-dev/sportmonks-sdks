...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixturesByDateResponse_data_inner")]
    public partial class SportFixturesByDateResponseDataInner : IEquatable<SportFixturesByDateResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixturesByDateResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixturesByDateResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportFixturesByDateResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportFixturesByDateResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixturesByDateResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixturesByDateResponseDataInner input)
        {
            if (input == null)
            {
                return false;
