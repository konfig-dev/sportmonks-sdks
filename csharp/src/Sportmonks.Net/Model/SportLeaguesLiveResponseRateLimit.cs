...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeaguesLiveResponse_rate_limit")]
    public partial class SportLeaguesLiveResponseRateLimit : IEquatable<SportLeaguesLiveResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeaguesLiveResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportLeaguesLiveResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeaguesLiveResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportLeaguesLiveResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportLeaguesLiveResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeaguesLiveResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeaguesLiveResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
