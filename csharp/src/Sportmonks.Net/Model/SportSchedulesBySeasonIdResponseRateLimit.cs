...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesBySeasonIdResponse_rate_limit")]
    public partial class SportSchedulesBySeasonIdResponseRateLimit : IEquatable<SportSchedulesBySeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesBySeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportSchedulesBySeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesBySeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportSchedulesBySeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportSchedulesBySeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesBySeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesBySeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
