...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixturesAllResponse_rate_limit")]
    public partial class SportFixturesAllResponseRateLimit : IEquatable<SportFixturesAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixturesAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportFixturesAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixturesAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportFixturesAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportFixturesAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixturesAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixturesAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
