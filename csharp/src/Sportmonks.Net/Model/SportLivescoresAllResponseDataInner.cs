...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLivescoresAllResponse_data_inner")]
    public partial class SportLivescoresAllResponseDataInner : IEquatable<SportLivescoresAllResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLivescoresAllResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLivescoresAllResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportLivescoresAllResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportLivescoresAllResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLivescoresAllResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLivescoresAllResponseDataInner input)
        {
            if (input == null)
            {
                return false;
