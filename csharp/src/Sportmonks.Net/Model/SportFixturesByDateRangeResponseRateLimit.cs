...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixturesByDateRangeResponse_rate_limit")]
    public partial class SportFixturesByDateRangeResponseRateLimit : IEquatable<SportFixturesByDateRangeResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixturesByDateRangeResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportFixturesByDateRangeResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixturesByDateRangeResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportFixturesByDateRangeResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportFixturesByDateRangeResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixturesByDateRangeResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixturesByDateRangeResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
