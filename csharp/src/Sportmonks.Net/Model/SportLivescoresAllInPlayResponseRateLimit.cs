...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLivescoresAllInPlayResponse_rate_limit")]
    public partial class SportLivescoresAllInPlayResponseRateLimit : IEquatable<SportLivescoresAllInPlayResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLivescoresAllInPlayResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportLivescoresAllInPlayResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLivescoresAllInPlayResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportLivescoresAllInPlayResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportLivescoresAllInPlayResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLivescoresAllInPlayResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLivescoresAllInPlayResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
