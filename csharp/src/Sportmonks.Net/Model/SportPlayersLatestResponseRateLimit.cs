...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPlayersLatestResponse_rate_limit")]
    public partial class SportPlayersLatestResponseRateLimit : IEquatable<SportPlayersLatestResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPlayersLatestResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportPlayersLatestResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPlayersLatestResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportPlayersLatestResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportPlayersLatestResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPlayersLatestResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPlayersLatestResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
