...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportCoachesAllResponse_data_inner")]
    public partial class SportCoachesAllResponseDataInner : IEquatable<SportCoachesAllResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportCoachesAllResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportCoachesAllResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportCoachesAllResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportCoachesAllResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportCoachesAllResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportCoachesAllResponseDataInner input)
        {
            if (input == null)
            {
                return false;
