...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRefereesSearchResponse_rate_limit")]
    public partial class SportRefereesSearchResponseRateLimit : IEquatable<SportRefereesSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRefereesSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportRefereesSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRefereesSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportRefereesSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportRefereesSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRefereesSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRefereesSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
