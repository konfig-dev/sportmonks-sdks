...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RegionsSearchResponse_rate_limit")]
    public partial class RegionsSearchResponseRateLimit : IEquatable<RegionsSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegionsSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public RegionsSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RegionsSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as RegionsSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if RegionsSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of RegionsSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegionsSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
