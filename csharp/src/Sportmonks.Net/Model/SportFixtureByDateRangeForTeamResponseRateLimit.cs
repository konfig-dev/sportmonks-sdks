...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixtureByDateRangeForTeamResponse_rate_limit")]
    public partial class SportFixtureByDateRangeForTeamResponseRateLimit : IEquatable<SportFixtureByDateRangeForTeamResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixtureByDateRangeForTeamResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportFixtureByDateRangeForTeamResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixtureByDateRangeForTeamResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportFixtureByDateRangeForTeamResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportFixtureByDateRangeForTeamResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixtureByDateRangeForTeamResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixtureByDateRangeForTeamResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
