...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTeamsBySeasonIdResponse_data_inner")]
    public partial class SportTeamsBySeasonIdResponseDataInner : IEquatable<SportTeamsBySeasonIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTeamsBySeasonIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportTeamsBySeasonIdResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), decimal venueId = default(decimal), string gender = default(string), string name = default(string), string shortCode = default(string), string imagePath = default(string), decimal founded = default(decimal), string type = default(string), bool placeholder = default(bool), string lastPlayedAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTeamsBySeasonIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportTeamsBySeasonIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportTeamsBySeasonIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTeamsBySeasonIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTeamsBySeasonIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
