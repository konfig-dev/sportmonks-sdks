...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CitiesAllResponse_rate_limit")]
    public partial class CitiesAllResponseRateLimit : IEquatable<CitiesAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CitiesAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public CitiesAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CitiesAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as CitiesAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if CitiesAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of CitiesAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CitiesAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
