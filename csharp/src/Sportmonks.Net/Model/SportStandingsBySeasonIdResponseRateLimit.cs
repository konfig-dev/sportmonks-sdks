...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStandingsBySeasonIdResponse_rate_limit")]
    public partial class SportStandingsBySeasonIdResponseRateLimit : IEquatable<SportStandingsBySeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStandingsBySeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStandingsBySeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStandingsBySeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStandingsBySeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStandingsBySeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStandingsBySeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStandingsBySeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
