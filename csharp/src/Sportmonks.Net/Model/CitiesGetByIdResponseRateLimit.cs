...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CitiesGetByIdResponse_rate_limit")]
    public partial class CitiesGetByIdResponseRateLimit : IEquatable<CitiesGetByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CitiesGetByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public CitiesGetByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CitiesGetByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as CitiesGetByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if CitiesGetByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of CitiesGetByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CitiesGetByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
