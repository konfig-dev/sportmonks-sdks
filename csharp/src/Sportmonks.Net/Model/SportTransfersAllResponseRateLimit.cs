...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTransfersAllResponse_rate_limit")]
    public partial class SportTransfersAllResponseRateLimit : IEquatable<SportTransfersAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTransfersAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTransfersAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTransfersAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTransfersAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTransfersAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTransfersAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTransfersAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
