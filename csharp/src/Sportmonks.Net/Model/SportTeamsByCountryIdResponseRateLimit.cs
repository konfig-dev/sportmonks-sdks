...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTeamsByCountryIdResponse_rate_limit")]
    public partial class SportTeamsByCountryIdResponseRateLimit : IEquatable<SportTeamsByCountryIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTeamsByCountryIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTeamsByCountryIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTeamsByCountryIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTeamsByCountryIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTeamsByCountryIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTeamsByCountryIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTeamsByCountryIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
