...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStandingCorrectionsBySeasonIdResponse_rate_limit")]
    public partial class SportStandingCorrectionsBySeasonIdResponseRateLimit : IEquatable<SportStandingCorrectionsBySeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStandingCorrectionsBySeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStandingCorrectionsBySeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStandingCorrectionsBySeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStandingCorrectionsBySeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStandingCorrectionsBySeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStandingCorrectionsBySeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStandingCorrectionsBySeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
