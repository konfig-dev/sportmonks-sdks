...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CountriesSearchResponse_rate_limit")]
    public partial class CountriesSearchResponseRateLimit : IEquatable<CountriesSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountriesSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public CountriesSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CountriesSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as CountriesSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if CountriesSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of CountriesSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountriesSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
