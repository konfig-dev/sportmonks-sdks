...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTeamsByIdResponse_data")]
    public partial class SportTeamsByIdResponseData : IEquatable<SportTeamsByIdResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTeamsByIdResponseData" /> class.
        /// </summary>
        ...
        public SportTeamsByIdResponseData(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), decimal venueId = default(decimal), string gender = default(string), string name = default(string), string shortCode = default(string), string imagePath = default(string), decimal founded = default(decimal), string type = default(string), bool placeholder = default(bool), string lastPlayedAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTeamsByIdResponseData {\n");
        ...
        {
            return this.Equals(input as SportTeamsByIdResponseData);
        }

        /// <summary>
        /// Returns true if SportTeamsByIdResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTeamsByIdResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTeamsByIdResponseData input)
        {
            if (input == null)
            {
                return false;
