...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportCoachesLatestResponse_rate_limit")]
    public partial class SportCoachesLatestResponseRateLimit : IEquatable<SportCoachesLatestResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportCoachesLatestResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportCoachesLatestResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportCoachesLatestResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportCoachesLatestResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportCoachesLatestResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportCoachesLatestResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportCoachesLatestResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
