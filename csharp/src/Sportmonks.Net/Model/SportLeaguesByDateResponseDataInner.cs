...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeaguesByDateResponse_data_inner")]
    public partial class SportLeaguesByDateResponseDataInner : IEquatable<SportLeaguesByDateResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeaguesByDateResponseDataInner" /> class.
        /// </summary>
        ...
        public SportLeaguesByDateResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string name = default(string), bool active = default(bool), string shortCode = default(string), string imagePath = default(string), string type = default(string), string subType = default(string), string lastPlayedAt = default(string), decimal category = default(decimal), bool hasJerseys = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeaguesByDateResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportLeaguesByDateResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportLeaguesByDateResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeaguesByDateResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeaguesByDateResponseDataInner input)
        {
            if (input == null)
            {
                return false;
