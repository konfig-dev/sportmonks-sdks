...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TypesGetByIdResponse_rate_limit")]
    public partial class TypesGetByIdResponseRateLimit : IEquatable<TypesGetByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TypesGetByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public TypesGetByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TypesGetByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as TypesGetByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if TypesGetByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of TypesGetByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TypesGetByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
