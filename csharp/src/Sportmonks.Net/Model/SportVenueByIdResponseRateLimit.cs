...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportVenueByIdResponse_rate_limit")]
    public partial class SportVenueByIdResponseRateLimit : IEquatable<SportVenueByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportVenueByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportVenueByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportVenueByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportVenueByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportVenueByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportVenueByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportVenueByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
