...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStandingsByRoundIdResponse_rate_limit")]
    public partial class SportStandingsByRoundIdResponseRateLimit : IEquatable<SportStandingsByRoundIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStandingsByRoundIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStandingsByRoundIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStandingsByRoundIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStandingsByRoundIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStandingsByRoundIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStandingsByRoundIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStandingsByRoundIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
