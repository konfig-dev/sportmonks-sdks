...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportOddsAllPreMatchResponse_data_inner")]
    public partial class SportOddsAllPreMatchResponseDataInner : IEquatable<SportOddsAllPreMatchResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportOddsAllPreMatchResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportOddsAllPreMatchResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportOddsAllPreMatchResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportOddsAllPreMatchResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportOddsAllPreMatchResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportOddsAllPreMatchResponseDataInner input)
        {
            if (input == null)
            {
                return false;
