...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CountriesGetByIdResponse_rate_limit")]
    public partial class CountriesGetByIdResponseRateLimit : IEquatable<CountriesGetByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountriesGetByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public CountriesGetByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CountriesGetByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as CountriesGetByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if CountriesGetByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of CountriesGetByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountriesGetByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
