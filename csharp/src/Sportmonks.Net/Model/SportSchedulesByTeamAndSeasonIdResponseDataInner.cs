...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesByTeamAndSeasonIdResponse_data_inner")]
    public partial class SportSchedulesByTeamAndSeasonIdResponseDataInner : IEquatable<SportSchedulesByTeamAndSeasonIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesByTeamAndSeasonIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportSchedulesByTeamAndSeasonIdResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal leagueId = default(decimal), decimal seasonId = default(decimal), decimal typeId = default(decimal), string name = default(string), decimal sortOrder = default(decimal), bool finished = default(bool), bool isCurrent = default(bool), string startingAt = default(string), string endingAt = default(string), List<string> aggregates = default(List<string>), List<SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner> rounds = default(List<SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner>))
        {
            this.Id = id;
        ...
        public List<SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner> Rounds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesByTeamAndSeasonIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportSchedulesByTeamAndSeasonIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportSchedulesByTeamAndSeasonIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesByTeamAndSeasonIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesByTeamAndSeasonIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
