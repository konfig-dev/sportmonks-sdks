...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeaguesAllResponse_rate_limit")]
    public partial class SportLeaguesAllResponseRateLimit : IEquatable<SportLeaguesAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeaguesAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportLeaguesAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeaguesAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportLeaguesAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportLeaguesAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeaguesAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeaguesAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
