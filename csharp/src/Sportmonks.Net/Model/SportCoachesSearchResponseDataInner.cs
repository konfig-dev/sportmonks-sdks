...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportCoachesSearchResponse_data_inner")]
    public partial class SportCoachesSearchResponseDataInner : IEquatable<SportCoachesSearchResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportCoachesSearchResponseDataInner" /> class.
        /// </summary>
        ...
        public SportCoachesSearchResponseDataInner(decimal id = default(decimal), decimal playerId = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string nationalityId = default(string), string cityId = default(string), string commonName = default(string), string firstname = default(string), string lastname = default(string), string name = default(string), string displayName = default(string), string imagePath = default(string), SportCoachesSearchResponseDataInnerHeight height = default(SportCoachesSearchResponseDataInnerHeight), SportCoachesSearchResponseDataInnerWeight weight = default(SportCoachesSearchResponseDataInnerWeight), string dateOfBirth = default(string), string gender = default(string))
        {
            this.Id = id;
        ...
        public SportCoachesSearchResponseDataInnerHeight Height { get; set; }

        /// <summary>
        /// Gets or Sets Weight
        /// </summary>
        [DataMember(Name = "weight", EmitDefaultValue = false)]
        public SportCoachesSearchResponseDataInnerWeight Weight { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportCoachesSearchResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportCoachesSearchResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportCoachesSearchResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportCoachesSearchResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportCoachesSearchResponseDataInner input)
        {
            if (input == null)
            {
                return false;
