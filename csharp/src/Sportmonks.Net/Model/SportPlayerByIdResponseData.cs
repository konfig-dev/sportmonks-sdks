...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPlayerByIdResponse_data")]
    public partial class SportPlayerByIdResponseData : IEquatable<SportPlayerByIdResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPlayerByIdResponseData" /> class.
        /// </summary>
        ...
        public SportPlayerByIdResponseData(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), decimal nationalityId = default(decimal), string cityId = default(string), decimal positionId = default(decimal), string detailedPositionId = default(string), decimal typeId = default(decimal), string commonName = default(string), string firstname = default(string), string lastname = default(string), string name = default(string), string displayName = default(string), string imagePath = default(string), decimal height = default(decimal), decimal weight = default(decimal), string dateOfBirth = default(string), string gender = default(string))
        {
            this.Id = id;
        ...
        public string DetailedPositionId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPlayerByIdResponseData {\n");
        ...
        {
            return this.Equals(input as SportPlayerByIdResponseData);
        }

        /// <summary>
        /// Returns true if SportPlayerByIdResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPlayerByIdResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPlayerByIdResponseData input)
        {
            if (input == null)
            {
                return false;
