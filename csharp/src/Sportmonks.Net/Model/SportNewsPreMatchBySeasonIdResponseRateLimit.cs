...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportNewsPreMatchBySeasonIdResponse_rate_limit")]
    public partial class SportNewsPreMatchBySeasonIdResponseRateLimit : IEquatable<SportNewsPreMatchBySeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportNewsPreMatchBySeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportNewsPreMatchBySeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportNewsPreMatchBySeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportNewsPreMatchBySeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportNewsPreMatchBySeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportNewsPreMatchBySeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportNewsPreMatchBySeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
