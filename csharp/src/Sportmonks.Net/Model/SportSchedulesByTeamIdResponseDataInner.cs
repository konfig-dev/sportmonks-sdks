...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesByTeamIdResponse_data_inner")]
    public partial class SportSchedulesByTeamIdResponseDataInner : IEquatable<SportSchedulesByTeamIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesByTeamIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportSchedulesByTeamIdResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal leagueId = default(decimal), decimal seasonId = default(decimal), decimal typeId = default(decimal), string name = default(string), decimal sortOrder = default(decimal), bool finished = default(bool), bool isCurrent = default(bool), string startingAt = default(string), string endingAt = default(string), List<string> aggregates = default(List<string>), List<SportSchedulesByTeamIdResponseDataInnerRoundsInner> rounds = default(List<SportSchedulesByTeamIdResponseDataInnerRoundsInner>))
        {
            this.Id = id;
        ...
        public List<SportSchedulesByTeamIdResponseDataInnerRoundsInner> Rounds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesByTeamIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportSchedulesByTeamIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportSchedulesByTeamIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesByTeamIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesByTeamIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
