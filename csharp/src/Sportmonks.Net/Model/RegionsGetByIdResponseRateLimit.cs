...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RegionsGetByIdResponse_rate_limit")]
    public partial class RegionsGetByIdResponseRateLimit : IEquatable<RegionsGetByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegionsGetByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public RegionsGetByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RegionsGetByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as RegionsGetByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if RegionsGetByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of RegionsGetByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegionsGetByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
