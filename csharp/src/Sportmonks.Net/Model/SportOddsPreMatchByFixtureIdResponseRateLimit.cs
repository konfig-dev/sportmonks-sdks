...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportOddsPreMatchByFixtureIdResponse_rate_limit")]
    public partial class SportOddsPreMatchByFixtureIdResponseRateLimit : IEquatable<SportOddsPreMatchByFixtureIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportOddsPreMatchByFixtureIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportOddsPreMatchByFixtureIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportOddsPreMatchByFixtureIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportOddsPreMatchByFixtureIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportOddsPreMatchByFixtureIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportOddsPreMatchByFixtureIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportOddsPreMatchByFixtureIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
