...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRoundByIdResponse_data")]
    public partial class SportRoundByIdResponseData : IEquatable<SportRoundByIdResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRoundByIdResponseData" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRoundByIdResponseData {\n");
        ...
        {
            return this.Equals(input as SportRoundByIdResponseData);
        }

        /// <summary>
        /// Returns true if SportRoundByIdResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRoundByIdResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRoundByIdResponseData input)
        {
            if (input == null)
            {
                return false;
