...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPlayersAllResponse_data_inner")]
    public partial class SportPlayersAllResponseDataInner : IEquatable<SportPlayersAllResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPlayersAllResponseDataInner" /> class.
        /// </summary>
        ...
        public SportPlayersAllResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), decimal nationalityId = default(decimal), string cityId = default(string), decimal positionId = default(decimal), SportPlayersAllResponseDataInnerDetailedPositionId detailedPositionId = default(SportPlayersAllResponseDataInnerDetailedPositionId), decimal typeId = default(decimal), string commonName = default(string), string firstname = default(string), string lastname = default(string), string name = default(string), string displayName = default(string), string imagePath = default(string), decimal height = default(decimal), decimal weight = default(decimal), string dateOfBirth = default(string), string gender = default(string))
        {
            this.Id = id;
        ...
        public SportPlayersAllResponseDataInnerDetailedPositionId DetailedPositionId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPlayersAllResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportPlayersAllResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportPlayersAllResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPlayersAllResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPlayersAllResponseDataInner input)
        {
            if (input == null)
            {
                return false;
