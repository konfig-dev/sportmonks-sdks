...
namespace Sportmonks.Net.Model
{
    ...
    public partial class SportPlayersAllResponseDataInner : IEquatable<SportPlayersAllResponseDataInner>, IValidatableObject
    {
        ...
        public SportPlayersAllResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), decimal nationalityId = default(decimal), string cityId = default(string), decimal positionId = default(decimal), decimal? detailedPositionId = default(decimal?), decimal typeId = default(decimal), string commonName = default(string), string firstname = default(string), string lastname = default(string), string name = default(string), string displayName = default(string), string imagePath = default(string), decimal height = default(decimal), decimal weight = default(decimal), string dateOfBirth = default(string), string gender = default(string))
        {
            this.Id = id;
