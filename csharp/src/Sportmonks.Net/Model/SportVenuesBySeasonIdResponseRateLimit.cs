...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportVenuesBySeasonIdResponse_rate_limit")]
    public partial class SportVenuesBySeasonIdResponseRateLimit : IEquatable<SportVenuesBySeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportVenuesBySeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportVenuesBySeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportVenuesBySeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportVenuesBySeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportVenuesBySeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportVenuesBySeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportVenuesBySeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
