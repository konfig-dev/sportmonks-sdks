...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRivalsByTeamIdResponse_rate_limit")]
    public partial class SportRivalsByTeamIdResponseRateLimit : IEquatable<SportRivalsByTeamIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRivalsByTeamIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportRivalsByTeamIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRivalsByTeamIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportRivalsByTeamIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportRivalsByTeamIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRivalsByTeamIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRivalsByTeamIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
