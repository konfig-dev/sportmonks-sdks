...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSquadsBySeasonAndTeamIdResponse_rate_limit")]
    public partial class SportSquadsBySeasonAndTeamIdResponseRateLimit : IEquatable<SportSquadsBySeasonAndTeamIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSquadsBySeasonAndTeamIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportSquadsBySeasonAndTeamIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSquadsBySeasonAndTeamIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportSquadsBySeasonAndTeamIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportSquadsBySeasonAndTeamIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSquadsBySeasonAndTeamIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSquadsBySeasonAndTeamIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
