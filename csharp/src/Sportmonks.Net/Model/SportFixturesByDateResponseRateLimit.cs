...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixturesByDateResponse_rate_limit")]
    public partial class SportFixturesByDateResponseRateLimit : IEquatable<SportFixturesByDateResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixturesByDateResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportFixturesByDateResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixturesByDateResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportFixturesByDateResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportFixturesByDateResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixturesByDateResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixturesByDateResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
