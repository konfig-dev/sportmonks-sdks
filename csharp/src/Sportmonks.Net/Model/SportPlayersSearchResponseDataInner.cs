...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPlayersSearchResponse_data_inner")]
    public partial class SportPlayersSearchResponseDataInner : IEquatable<SportPlayersSearchResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPlayersSearchResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPlayersSearchResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportPlayersSearchResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportPlayersSearchResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPlayersSearchResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPlayersSearchResponseDataInner input)
        {
            if (input == null)
            {
                return false;
