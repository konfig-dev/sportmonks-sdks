...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTvStationsByFixtureIdResponse_rate_limit")]
    public partial class SportTvStationsByFixtureIdResponseRateLimit : IEquatable<SportTvStationsByFixtureIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTvStationsByFixtureIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTvStationsByFixtureIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTvStationsByFixtureIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTvStationsByFixtureIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTvStationsByFixtureIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTvStationsByFixtureIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTvStationsByFixtureIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
