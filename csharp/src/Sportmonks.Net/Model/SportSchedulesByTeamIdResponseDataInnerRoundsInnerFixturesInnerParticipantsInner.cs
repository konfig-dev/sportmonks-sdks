...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesByTeamIdResponse_data_inner_rounds_inner_fixtures_inner_participants_inner")]
    public partial class SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner : IEquatable<SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner" /> class.
        /// </summary>
        ...
        public SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), decimal venueId = default(decimal), string gender = default(string), string name = default(string), string shortCode = default(string), string imagePath = default(string), decimal founded = default(decimal), string type = default(string), bool placeholder = default(bool), string lastPlayedAt = default(string), SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInnerMeta meta = default(SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInnerMeta))
        {
            this.Id = id;
        ...
        public SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInnerMeta Meta { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner {\n");
        ...
        {
            return this.Equals(input as SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner);
        }

        /// <summary>
        /// Returns true if SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesByTeamIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner input)
        {
            if (input == null)
            {
                return false;
