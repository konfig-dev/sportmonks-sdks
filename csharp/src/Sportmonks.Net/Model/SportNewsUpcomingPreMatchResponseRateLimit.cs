...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportNewsUpcomingPreMatchResponse_rate_limit")]
    public partial class SportNewsUpcomingPreMatchResponseRateLimit : IEquatable<SportNewsUpcomingPreMatchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportNewsUpcomingPreMatchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportNewsUpcomingPreMatchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportNewsUpcomingPreMatchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportNewsUpcomingPreMatchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportNewsUpcomingPreMatchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportNewsUpcomingPreMatchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportNewsUpcomingPreMatchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
