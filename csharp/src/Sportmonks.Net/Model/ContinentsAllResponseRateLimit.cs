...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContinentsAllResponse_rate_limit")]
    public partial class ContinentsAllResponseRateLimit : IEquatable<ContinentsAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContinentsAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public ContinentsAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContinentsAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as ContinentsAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if ContinentsAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of ContinentsAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContinentsAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
