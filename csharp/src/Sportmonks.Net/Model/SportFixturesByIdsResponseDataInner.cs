...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixturesByIdsResponse_data_inner")]
    public partial class SportFixturesByIdsResponseDataInner : IEquatable<SportFixturesByIdsResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixturesByIdsResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixturesByIdsResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportFixturesByIdsResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportFixturesByIdsResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixturesByIdsResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixturesByIdsResponseDataInner input)
        {
            if (input == null)
            {
                return false;
