...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportCoachesAllResponse_rate_limit")]
    public partial class SportCoachesAllResponseRateLimit : IEquatable<SportCoachesAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportCoachesAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportCoachesAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportCoachesAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportCoachesAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportCoachesAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportCoachesAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportCoachesAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
