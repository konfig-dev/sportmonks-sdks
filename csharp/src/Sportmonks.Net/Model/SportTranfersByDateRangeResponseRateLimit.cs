...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTranfersByDateRangeResponse_rate_limit")]
    public partial class SportTranfersByDateRangeResponseRateLimit : IEquatable<SportTranfersByDateRangeResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTranfersByDateRangeResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTranfersByDateRangeResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTranfersByDateRangeResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTranfersByDateRangeResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTranfersByDateRangeResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTranfersByDateRangeResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTranfersByDateRangeResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
