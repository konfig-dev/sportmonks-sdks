...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTranfersByDateRangeResponse_data_inner")]
    public partial class SportTranfersByDateRangeResponseDataInner : IEquatable<SportTranfersByDateRangeResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTranfersByDateRangeResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTranfersByDateRangeResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportTranfersByDateRangeResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportTranfersByDateRangeResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTranfersByDateRangeResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTranfersByDateRangeResponseDataInner input)
        {
            if (input == null)
            {
                return false;
