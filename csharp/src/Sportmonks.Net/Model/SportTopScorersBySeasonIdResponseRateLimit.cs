...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTopScorersBySeasonIdResponse_rate_limit")]
    public partial class SportTopScorersBySeasonIdResponseRateLimit : IEquatable<SportTopScorersBySeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTopScorersBySeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTopScorersBySeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTopScorersBySeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTopScorersBySeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTopScorersBySeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTopScorersBySeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTopScorersBySeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
