...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPlayerByIdResponse_rate_limit")]
    public partial class SportPlayerByIdResponseRateLimit : IEquatable<SportPlayerByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPlayerByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportPlayerByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPlayerByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportPlayerByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportPlayerByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPlayerByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPlayerByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
