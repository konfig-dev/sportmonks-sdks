...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CountriesAllResponse_data_inner")]
    public partial class CountriesAllResponseDataInner : IEquatable<CountriesAllResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountriesAllResponseDataInner" /> class.
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name = "fifa_name", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CountriesAllResponseDataInner {\n");
        ...
        {
            return this.Equals(input as CountriesAllResponseDataInner);
        }

        /// <summary>
        /// Returns true if CountriesAllResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of CountriesAllResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountriesAllResponseDataInner input)
        {
            if (input == null)
            {
                return false;
