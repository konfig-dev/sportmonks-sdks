...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeaguesAllResponse_data_inner")]
    public partial class SportLeaguesAllResponseDataInner : IEquatable<SportLeaguesAllResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeaguesAllResponseDataInner" /> class.
        /// </summary>
        ...
        public SportLeaguesAllResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string name = default(string), bool active = default(bool), string shortCode = default(string), string imagePath = default(string), string type = default(string), string subType = default(string), string lastPlayedAt = default(string), decimal category = default(decimal), bool hasJerseys = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeaguesAllResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportLeaguesAllResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportLeaguesAllResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeaguesAllResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeaguesAllResponseDataInner input)
        {
            if (input == null)
            {
                return false;
