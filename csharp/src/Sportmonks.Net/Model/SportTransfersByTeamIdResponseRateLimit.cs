...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTransfersByTeamIdResponse_rate_limit")]
    public partial class SportTransfersByTeamIdResponseRateLimit : IEquatable<SportTransfersByTeamIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTransfersByTeamIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTransfersByTeamIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTransfersByTeamIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTransfersByTeamIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTransfersByTeamIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTransfersByTeamIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTransfersByTeamIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
