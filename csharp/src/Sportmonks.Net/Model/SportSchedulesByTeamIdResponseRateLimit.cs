...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesByTeamIdResponse_rate_limit")]
    public partial class SportSchedulesByTeamIdResponseRateLimit : IEquatable<SportSchedulesByTeamIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesByTeamIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportSchedulesByTeamIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesByTeamIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportSchedulesByTeamIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportSchedulesByTeamIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesByTeamIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesByTeamIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
