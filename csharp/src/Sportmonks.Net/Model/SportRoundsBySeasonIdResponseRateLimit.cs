...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRoundsBySeasonIdResponse_rate_limit")]
    public partial class SportRoundsBySeasonIdResponseRateLimit : IEquatable<SportRoundsBySeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRoundsBySeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportRoundsBySeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRoundsBySeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportRoundsBySeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportRoundsBySeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRoundsBySeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRoundsBySeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
