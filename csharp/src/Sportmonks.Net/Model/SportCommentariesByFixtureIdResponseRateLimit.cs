...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportCommentariesByFixtureIdResponse_rate_limit")]
    public partial class SportCommentariesByFixtureIdResponseRateLimit : IEquatable<SportCommentariesByFixtureIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportCommentariesByFixtureIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportCommentariesByFixtureIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportCommentariesByFixtureIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportCommentariesByFixtureIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportCommentariesByFixtureIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportCommentariesByFixtureIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportCommentariesByFixtureIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
