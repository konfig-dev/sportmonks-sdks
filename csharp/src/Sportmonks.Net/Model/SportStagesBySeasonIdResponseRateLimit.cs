...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStagesBySeasonIdResponse_rate_limit")]
    public partial class SportStagesBySeasonIdResponseRateLimit : IEquatable<SportStagesBySeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStagesBySeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStagesBySeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStagesBySeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStagesBySeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStagesBySeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStagesBySeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStagesBySeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
