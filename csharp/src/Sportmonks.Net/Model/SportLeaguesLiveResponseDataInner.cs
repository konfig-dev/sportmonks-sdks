...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeaguesLiveResponse_data_inner")]
    public partial class SportLeaguesLiveResponseDataInner : IEquatable<SportLeaguesLiveResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeaguesLiveResponseDataInner" /> class.
        /// </summary>
        ...
        public SportLeaguesLiveResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string name = default(string), bool active = default(bool), string shortCode = default(string), string imagePath = default(string), string type = default(string), string subType = default(string), string lastPlayedAt = default(string), decimal category = default(decimal), bool hasJerseys = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeaguesLiveResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportLeaguesLiveResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportLeaguesLiveResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeaguesLiveResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeaguesLiveResponseDataInner input)
        {
            if (input == null)
            {
                return false;
