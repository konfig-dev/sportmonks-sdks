...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportOddsAllPreMatchResponse_rate_limit")]
    public partial class SportOddsAllPreMatchResponseRateLimit : IEquatable<SportOddsAllPreMatchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportOddsAllPreMatchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportOddsAllPreMatchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportOddsAllPreMatchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportOddsAllPreMatchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportOddsAllPreMatchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportOddsAllPreMatchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportOddsAllPreMatchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
