...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportCoachesSearchResponse_rate_limit")]
    public partial class SportCoachesSearchResponseRateLimit : IEquatable<SportCoachesSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportCoachesSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportCoachesSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportCoachesSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportCoachesSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportCoachesSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportCoachesSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportCoachesSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
