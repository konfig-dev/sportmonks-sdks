...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPredictionsByFixtureIdResponse_data_inner_predictions")]
    public partial class SportPredictionsByFixtureIdResponseDataInnerPredictions : IEquatable<SportPredictionsByFixtureIdResponseDataInnerPredictions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPredictionsByFixtureIdResponseDataInnerPredictions" /> class.
        /// </summary>
        ...
        public SportPredictionsByFixtureIdResponseDataInnerPredictions(decimal _true = default(decimal), decimal _false = default(decimal), SportPredictionsByFixtureIdResponseDataInnerPredictionsScores scores = default(SportPredictionsByFixtureIdResponseDataInnerPredictionsScores), decimal home = default(decimal), decimal draw = default(decimal), decimal away = default(decimal))
        {
            this.True = _true;
            this.False = _false;
            this.Scores = scores;
        ...
        public SportPredictionsByFixtureIdResponseDataInnerPredictionsScores Scores { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPredictionsByFixtureIdResponseDataInnerPredictions {\n");
        ...
        {
            return this.Equals(input as SportPredictionsByFixtureIdResponseDataInnerPredictions);
        }

        /// <summary>
        /// Returns true if SportPredictionsByFixtureIdResponseDataInnerPredictions instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPredictionsByFixtureIdResponseDataInnerPredictions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPredictionsByFixtureIdResponseDataInnerPredictions input)
        {
            if (input == null)
            {
                return false;
