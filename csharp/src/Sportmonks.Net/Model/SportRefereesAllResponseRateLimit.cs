...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRefereesAllResponse_rate_limit")]
    public partial class SportRefereesAllResponseRateLimit : IEquatable<SportRefereesAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRefereesAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportRefereesAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRefereesAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportRefereesAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportRefereesAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRefereesAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRefereesAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
