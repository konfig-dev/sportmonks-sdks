...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSeasonsAllResponse_rate_limit")]
    public partial class SportSeasonsAllResponseRateLimit : IEquatable<SportSeasonsAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSeasonsAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportSeasonsAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSeasonsAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportSeasonsAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportSeasonsAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSeasonsAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSeasonsAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
