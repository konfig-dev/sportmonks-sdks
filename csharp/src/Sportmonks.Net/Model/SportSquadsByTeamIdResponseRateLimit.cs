...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSquadsByTeamIdResponse_rate_limit")]
    public partial class SportSquadsByTeamIdResponseRateLimit : IEquatable<SportSquadsByTeamIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSquadsByTeamIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportSquadsByTeamIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSquadsByTeamIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportSquadsByTeamIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportSquadsByTeamIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSquadsByTeamIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSquadsByTeamIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
