...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLivescoresAllInPlayResponse_data_inner")]
    public partial class SportLivescoresAllInPlayResponseDataInner : IEquatable<SportLivescoresAllInPlayResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLivescoresAllInPlayResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLivescoresAllInPlayResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportLivescoresAllInPlayResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportLivescoresAllInPlayResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLivescoresAllInPlayResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLivescoresAllInPlayResponseDataInner input)
        {
            if (input == null)
            {
                return false;
