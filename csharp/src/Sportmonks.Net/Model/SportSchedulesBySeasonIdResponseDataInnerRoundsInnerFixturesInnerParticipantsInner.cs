...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesBySeasonIdResponse_data_inner_rounds_inner_fixtures_inner_participants_inner")]
    public partial class SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner : IEquatable<SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner" /> class.
        /// </summary>
        ...
        public SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), decimal venueId = default(decimal), string gender = default(string), string name = default(string), string shortCode = default(string), string imagePath = default(string), decimal founded = default(decimal), string type = default(string), bool placeholder = default(bool), string lastPlayedAt = default(string), SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInnerMeta meta = default(SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInnerMeta))
        {
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name = "short_code", EmitDefaultValue = true)]
        ...
        public SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInnerMeta Meta { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner {\n");
        ...
        {
            return this.Equals(input as SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner);
        }

        /// <summary>
        /// Returns true if SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner input)
        {
            if (input == null)
            {
                return false;
