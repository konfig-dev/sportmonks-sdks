...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixturesSearchResponse_data_inner")]
    public partial class SportFixturesSearchResponseDataInner : IEquatable<SportFixturesSearchResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixturesSearchResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixturesSearchResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportFixturesSearchResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportFixturesSearchResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixturesSearchResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixturesSearchResponseDataInner input)
        {
            if (input == null)
            {
                return false;
