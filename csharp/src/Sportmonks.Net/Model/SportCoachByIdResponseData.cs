...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportCoachByIdResponse_data")]
    public partial class SportCoachByIdResponseData : IEquatable<SportCoachByIdResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportCoachByIdResponseData" /> class.
        /// </summary>
        ...
        public SportCoachByIdResponseData(decimal id = default(decimal), decimal playerId = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string nationalityId = default(string), string cityId = default(string), string commonName = default(string), string firstname = default(string), string lastname = default(string), string name = default(string), string displayName = default(string), string imagePath = default(string), decimal height = default(decimal), decimal weight = default(decimal), string dateOfBirth = default(string), string gender = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportCoachByIdResponseData {\n");
        ...
        {
            return this.Equals(input as SportCoachByIdResponseData);
        }

        /// <summary>
        /// Returns true if SportCoachByIdResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of SportCoachByIdResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportCoachByIdResponseData input)
        {
            if (input == null)
            {
                return false;
