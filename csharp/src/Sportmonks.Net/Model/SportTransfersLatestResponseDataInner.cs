...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTransfersLatestResponse_data_inner")]
    public partial class SportTransfersLatestResponseDataInner : IEquatable<SportTransfersLatestResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTransfersLatestResponseDataInner" /> class.
        /// </summary>
        ...
        public SportTransfersLatestResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal playerId = default(decimal), decimal typeId = default(decimal), decimal fromTeamId = default(decimal), decimal toTeamId = default(decimal), SportTransfersLatestResponseDataInnerPositionId positionId = default(SportTransfersLatestResponseDataInnerPositionId), SportTransfersLatestResponseDataInnerDetailedPositionId detailedPositionId = default(SportTransfersLatestResponseDataInnerDetailedPositionId), string date = default(string), bool careerEnded = default(bool), bool completed = default(bool), string completedAt = default(string))
        {
            this.Id = id;
        ...
        public SportTransfersLatestResponseDataInnerPositionId PositionId { get; set; }

        /// <summary>
        /// Gets or Sets DetailedPositionId
        /// </summary>
        [DataMember(Name = "detailed_position_id", EmitDefaultValue = false)]
        public SportTransfersLatestResponseDataInnerDetailedPositionId DetailedPositionId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTransfersLatestResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportTransfersLatestResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportTransfersLatestResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTransfersLatestResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTransfersLatestResponseDataInner input)
        {
            if (input == null)
            {
                return false;
