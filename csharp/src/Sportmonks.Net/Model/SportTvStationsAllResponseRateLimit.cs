...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTvStationsAllResponse_rate_limit")]
    public partial class SportTvStationsAllResponseRateLimit : IEquatable<SportTvStationsAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTvStationsAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTvStationsAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTvStationsAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTvStationsAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTvStationsAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTvStationsAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTvStationsAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
