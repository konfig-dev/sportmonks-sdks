...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPlayersAllResponse_rate_limit")]
    public partial class SportPlayersAllResponseRateLimit : IEquatable<SportPlayersAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPlayersAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportPlayersAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPlayersAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportPlayersAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportPlayersAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPlayersAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPlayersAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
