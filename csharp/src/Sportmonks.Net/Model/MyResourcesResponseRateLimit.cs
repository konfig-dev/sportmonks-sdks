...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MyResourcesResponse_rate_limit")]
    public partial class MyResourcesResponseRateLimit : IEquatable<MyResourcesResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MyResourcesResponseRateLimit" /> class.
        /// </summary>
        ...
        public MyResourcesResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MyResourcesResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as MyResourcesResponseRateLimit);
        }

        /// <summary>
        /// Returns true if MyResourcesResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of MyResourcesResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MyResourcesResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
