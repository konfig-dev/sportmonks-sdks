...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MyLeaguesResponse_rate_limit")]
    public partial class MyLeaguesResponseRateLimit : IEquatable<MyLeaguesResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MyLeaguesResponseRateLimit" /> class.
        /// </summary>
        ...
        public MyLeaguesResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MyLeaguesResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as MyLeaguesResponseRateLimit);
        }

        /// <summary>
        /// Returns true if MyLeaguesResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of MyLeaguesResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MyLeaguesResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
