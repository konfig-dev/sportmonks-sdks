...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CitiesSearchResponse_rate_limit")]
    public partial class CitiesSearchResponseRateLimit : IEquatable<CitiesSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CitiesSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public CitiesSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CitiesSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as CitiesSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if CitiesSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of CitiesSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CitiesSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
