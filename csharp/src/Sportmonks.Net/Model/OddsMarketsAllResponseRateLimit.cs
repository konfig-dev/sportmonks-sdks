...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OddsMarketsAllResponse_rate_limit")]
    public partial class OddsMarketsAllResponseRateLimit : IEquatable<OddsMarketsAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OddsMarketsAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public OddsMarketsAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OddsMarketsAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as OddsMarketsAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if OddsMarketsAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of OddsMarketsAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OddsMarketsAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
