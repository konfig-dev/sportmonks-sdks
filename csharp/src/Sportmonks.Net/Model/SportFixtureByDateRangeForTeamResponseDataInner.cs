...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixtureByDateRangeForTeamResponse_data_inner")]
    public partial class SportFixtureByDateRangeForTeamResponseDataInner : IEquatable<SportFixtureByDateRangeForTeamResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixtureByDateRangeForTeamResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixtureByDateRangeForTeamResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportFixtureByDateRangeForTeamResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportFixtureByDateRangeForTeamResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixtureByDateRangeForTeamResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixtureByDateRangeForTeamResponseDataInner input)
        {
            if (input == null)
            {
                return false;
