...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportOddsInPlayByFixtureIdResponse_data_inner")]
    public partial class SportOddsInPlayByFixtureIdResponseDataInner : IEquatable<SportOddsInPlayByFixtureIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportOddsInPlayByFixtureIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportOddsInPlayByFixtureIdResponseDataInner(decimal id = default(decimal), decimal fixtureId = default(decimal), decimal providerId = default(decimal), string externalId = default(string), decimal marketId = default(decimal), decimal bookmakerId = default(decimal), string label = default(string), string value = default(string), string name = default(string), decimal sortOrder = default(decimal), string marketDescription = default(string), string probability = default(string), string dp3 = default(string), string fractional = default(string), string american = default(string), bool winning = default(bool), bool suspended = default(bool), bool stopped = default(bool), string total = default(string), string handicap = default(string), string participants = default(string), string createdAt = default(string), string updatedAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportOddsInPlayByFixtureIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportOddsInPlayByFixtureIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportOddsInPlayByFixtureIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportOddsInPlayByFixtureIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportOddsInPlayByFixtureIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
