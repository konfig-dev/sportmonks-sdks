...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixtureByIdResponse_rate_limit")]
    public partial class SportFixtureByIdResponseRateLimit : IEquatable<SportFixtureByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixtureByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportFixtureByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixtureByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportFixtureByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportFixtureByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixtureByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixtureByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
