...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPredictionsAllValueBetsResponse_rate_limit")]
    public partial class SportPredictionsAllValueBetsResponseRateLimit : IEquatable<SportPredictionsAllValueBetsResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPredictionsAllValueBetsResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportPredictionsAllValueBetsResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPredictionsAllValueBetsResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportPredictionsAllValueBetsResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportPredictionsAllValueBetsResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPredictionsAllValueBetsResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPredictionsAllValueBetsResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
