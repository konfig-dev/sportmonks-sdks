...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPredictionsAllResponse_rate_limit")]
    public partial class SportPredictionsAllResponseRateLimit : IEquatable<SportPredictionsAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPredictionsAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportPredictionsAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPredictionsAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportPredictionsAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportPredictionsAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPredictionsAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPredictionsAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
