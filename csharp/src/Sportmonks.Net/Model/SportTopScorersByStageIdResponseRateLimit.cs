...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTopScorersByStageIdResponse_rate_limit")]
    public partial class SportTopScorersByStageIdResponseRateLimit : IEquatable<SportTopScorersByStageIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTopScorersByStageIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTopScorersByStageIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTopScorersByStageIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTopScorersByStageIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTopScorersByStageIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTopScorersByStageIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTopScorersByStageIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
