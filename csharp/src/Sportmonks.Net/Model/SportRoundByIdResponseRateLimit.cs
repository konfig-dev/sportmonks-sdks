...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRoundByIdResponse_rate_limit")]
    public partial class SportRoundByIdResponseRateLimit : IEquatable<SportRoundByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRoundByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportRoundByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRoundByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportRoundByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportRoundByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRoundByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRoundByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
