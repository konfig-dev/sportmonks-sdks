...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRefereesByCountryIdResponse_rate_limit")]
    public partial class SportRefereesByCountryIdResponseRateLimit : IEquatable<SportRefereesByCountryIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRefereesByCountryIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportRefereesByCountryIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRefereesByCountryIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportRefereesByCountryIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportRefereesByCountryIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRefereesByCountryIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRefereesByCountryIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
