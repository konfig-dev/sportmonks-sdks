...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRefereeByIdResponse_rate_limit")]
    public partial class SportRefereeByIdResponseRateLimit : IEquatable<SportRefereeByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRefereeByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportRefereeByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRefereeByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportRefereeByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportRefereeByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRefereeByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRefereeByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
