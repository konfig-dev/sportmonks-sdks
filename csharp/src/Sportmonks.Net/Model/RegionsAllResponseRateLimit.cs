...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RegionsAllResponse_rate_limit")]
    public partial class RegionsAllResponseRateLimit : IEquatable<RegionsAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegionsAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public RegionsAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RegionsAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as RegionsAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if RegionsAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of RegionsAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegionsAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
