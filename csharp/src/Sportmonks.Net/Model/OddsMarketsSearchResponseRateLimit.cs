...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OddsMarketsSearchResponse_rate_limit")]
    public partial class OddsMarketsSearchResponseRateLimit : IEquatable<OddsMarketsSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OddsMarketsSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public OddsMarketsSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OddsMarketsSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as OddsMarketsSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if OddsMarketsSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of OddsMarketsSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OddsMarketsSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
