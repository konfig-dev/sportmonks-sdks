...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeaguesByDateResponse_rate_limit")]
    public partial class SportLeaguesByDateResponseRateLimit : IEquatable<SportLeaguesByDateResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeaguesByDateResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportLeaguesByDateResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeaguesByDateResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportLeaguesByDateResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportLeaguesByDateResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeaguesByDateResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeaguesByDateResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
