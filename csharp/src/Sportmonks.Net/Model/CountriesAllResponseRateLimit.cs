...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CountriesAllResponse_rate_limit")]
    public partial class CountriesAllResponseRateLimit : IEquatable<CountriesAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountriesAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public CountriesAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CountriesAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as CountriesAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if CountriesAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of CountriesAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountriesAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
