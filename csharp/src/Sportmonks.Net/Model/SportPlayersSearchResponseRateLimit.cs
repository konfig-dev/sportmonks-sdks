...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPlayersSearchResponse_rate_limit")]
    public partial class SportPlayersSearchResponseRateLimit : IEquatable<SportPlayersSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPlayersSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportPlayersSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPlayersSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportPlayersSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportPlayersSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPlayersSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPlayersSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
