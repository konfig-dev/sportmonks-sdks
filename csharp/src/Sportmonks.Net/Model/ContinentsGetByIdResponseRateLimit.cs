...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContinentsGetByIdResponse_rate_limit")]
    public partial class ContinentsGetByIdResponseRateLimit : IEquatable<ContinentsGetByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContinentsGetByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public ContinentsGetByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContinentsGetByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as ContinentsGetByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if ContinentsGetByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of ContinentsGetByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContinentsGetByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
