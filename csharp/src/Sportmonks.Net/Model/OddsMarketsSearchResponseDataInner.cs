...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OddsMarketsSearchResponse_data_inner")]
    public partial class OddsMarketsSearchResponseDataInner : IEquatable<OddsMarketsSearchResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OddsMarketsSearchResponseDataInner" /> class.
        /// </summary>
        ...
        public OddsMarketsSearchResponseDataInner(decimal id = default(decimal), decimal legacyId = default(decimal), string name = default(string), string developerName = default(string), bool hasWinningCalculations = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OddsMarketsSearchResponseDataInner {\n");
        ...
        {
            return this.Equals(input as OddsMarketsSearchResponseDataInner);
        }

        /// <summary>
        /// Returns true if OddsMarketsSearchResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of OddsMarketsSearchResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OddsMarketsSearchResponseDataInner input)
        {
            if (input == null)
            {
                return false;
