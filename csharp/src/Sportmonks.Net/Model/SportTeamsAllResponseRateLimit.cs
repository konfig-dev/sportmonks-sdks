...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTeamsAllResponse_rate_limit")]
    public partial class SportTeamsAllResponseRateLimit : IEquatable<SportTeamsAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTeamsAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTeamsAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTeamsAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTeamsAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTeamsAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTeamsAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTeamsAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
