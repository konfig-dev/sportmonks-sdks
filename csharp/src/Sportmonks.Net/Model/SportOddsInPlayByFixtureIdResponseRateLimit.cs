...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportOddsInPlayByFixtureIdResponse_rate_limit")]
    public partial class SportOddsInPlayByFixtureIdResponseRateLimit : IEquatable<SportOddsInPlayByFixtureIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportOddsInPlayByFixtureIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportOddsInPlayByFixtureIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportOddsInPlayByFixtureIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportOddsInPlayByFixtureIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportOddsInPlayByFixtureIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportOddsInPlayByFixtureIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportOddsInPlayByFixtureIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
