...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTransferByIdResponse_rate_limit")]
    public partial class SportTransferByIdResponseRateLimit : IEquatable<SportTransferByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTransferByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTransferByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTransferByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTransferByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTransferByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTransferByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTransferByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
