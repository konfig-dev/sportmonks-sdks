...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRoundsBySeasonIdResponse_data_inner")]
    public partial class SportRoundsBySeasonIdResponseDataInner : IEquatable<SportRoundsBySeasonIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRoundsBySeasonIdResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRoundsBySeasonIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportRoundsBySeasonIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportRoundsBySeasonIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRoundsBySeasonIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRoundsBySeasonIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
