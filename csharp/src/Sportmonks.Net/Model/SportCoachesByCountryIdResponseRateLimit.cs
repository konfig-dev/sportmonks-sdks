...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportCoachesByCountryIdResponse_rate_limit")]
    public partial class SportCoachesByCountryIdResponseRateLimit : IEquatable<SportCoachesByCountryIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportCoachesByCountryIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportCoachesByCountryIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportCoachesByCountryIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportCoachesByCountryIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportCoachesByCountryIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportCoachesByCountryIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportCoachesByCountryIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
