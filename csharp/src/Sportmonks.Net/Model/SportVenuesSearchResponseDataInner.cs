...
namespace Sportmonks.Net.Model
{
    ...
    public partial class SportVenuesSearchResponseDataInner : IEquatable<SportVenuesSearchResponseDataInner>, IValidatableObject
    {
        ...
        public SportVenuesSearchResponseDataInner(decimal id = default(decimal), decimal? countryId = default(decimal?), decimal? cityId = default(decimal?), string name = default(string), string address = default(string), string zipcode = default(string), string latitude = default(string), string longitude = default(string), decimal? capacity = default(decimal?), string imagePath = default(string), string cityName = default(string), string surface = default(string), bool nationalTeam = default(bool))
        {
            this.Id = id;
