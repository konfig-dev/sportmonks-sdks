...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OddsMarketByIdResponse_data")]
    public partial class OddsMarketByIdResponseData : IEquatable<OddsMarketByIdResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OddsMarketByIdResponseData" /> class.
        /// </summary>
        ...
        public OddsMarketByIdResponseData(decimal id = default(decimal), decimal legacyId = default(decimal), string name = default(string), string developerName = default(string), bool hasWinningCalculations = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OddsMarketByIdResponseData {\n");
        ...
        {
            return this.Equals(input as OddsMarketByIdResponseData);
        }

        /// <summary>
        /// Returns true if OddsMarketByIdResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of OddsMarketByIdResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OddsMarketByIdResponseData input)
        {
            if (input == null)
            {
                return false;
