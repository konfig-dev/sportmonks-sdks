...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLivescoresLatestResponse_rate_limit")]
    public partial class SportLivescoresLatestResponseRateLimit : IEquatable<SportLivescoresLatestResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLivescoresLatestResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportLivescoresLatestResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLivescoresLatestResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportLivescoresLatestResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportLivescoresLatestResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLivescoresLatestResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLivescoresLatestResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
