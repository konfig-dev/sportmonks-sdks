...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTransfersLatestResponse_rate_limit")]
    public partial class SportTransfersLatestResponseRateLimit : IEquatable<SportTransfersLatestResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTransfersLatestResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTransfersLatestResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTransfersLatestResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTransfersLatestResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTransfersLatestResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTransfersLatestResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTransfersLatestResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
