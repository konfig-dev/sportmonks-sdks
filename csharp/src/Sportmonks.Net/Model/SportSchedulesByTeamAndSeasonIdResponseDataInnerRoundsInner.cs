...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesByTeamAndSeasonIdResponse_data_inner_rounds_inner")]
    public partial class SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner : IEquatable<SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner {\n");
        ...
        {
            return this.Equals(input as SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner);
        }

        /// <summary>
        /// Returns true if SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesByTeamAndSeasonIdResponseDataInnerRoundsInner input)
        {
            if (input == null)
            {
                return false;
