...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPlayersLatestResponse_data_inner")]
    public partial class SportPlayersLatestResponseDataInner : IEquatable<SportPlayersLatestResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPlayersLatestResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPlayersLatestResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportPlayersLatestResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportPlayersLatestResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPlayersLatestResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPlayersLatestResponseDataInner input)
        {
            if (input == null)
            {
                return false;
