...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTeamsByCountryIdResponse_data_inner")]
    public partial class SportTeamsByCountryIdResponseDataInner : IEquatable<SportTeamsByCountryIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTeamsByCountryIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportTeamsByCountryIdResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), decimal venueId = default(decimal), string gender = default(string), string name = default(string), string shortCode = default(string), string imagePath = default(string), decimal founded = default(decimal), string type = default(string), bool placeholder = default(bool), string lastPlayedAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTeamsByCountryIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportTeamsByCountryIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportTeamsByCountryIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTeamsByCountryIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTeamsByCountryIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
