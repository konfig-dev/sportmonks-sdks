...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPlayersByCountryIdResponse_rate_limit")]
    public partial class SportPlayersByCountryIdResponseRateLimit : IEquatable<SportPlayersByCountryIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPlayersByCountryIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportPlayersByCountryIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPlayersByCountryIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportPlayersByCountryIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportPlayersByCountryIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPlayersByCountryIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPlayersByCountryIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
