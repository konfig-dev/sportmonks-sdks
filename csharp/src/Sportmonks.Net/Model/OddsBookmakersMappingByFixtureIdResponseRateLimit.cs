...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OddsBookmakersMappingByFixtureIdResponse_rate_limit")]
    public partial class OddsBookmakersMappingByFixtureIdResponseRateLimit : IEquatable<OddsBookmakersMappingByFixtureIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OddsBookmakersMappingByFixtureIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public OddsBookmakersMappingByFixtureIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OddsBookmakersMappingByFixtureIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as OddsBookmakersMappingByFixtureIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if OddsBookmakersMappingByFixtureIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of OddsBookmakersMappingByFixtureIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OddsBookmakersMappingByFixtureIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
