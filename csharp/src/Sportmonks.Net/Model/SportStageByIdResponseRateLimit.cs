...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStageByIdResponse_rate_limit")]
    public partial class SportStageByIdResponseRateLimit : IEquatable<SportStageByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStageByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStageByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStageByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStageByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStageByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStageByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStageByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
