...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OddsMarketByIdResponse_rate_limit")]
    public partial class OddsMarketByIdResponseRateLimit : IEquatable<OddsMarketByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OddsMarketByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public OddsMarketByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OddsMarketByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as OddsMarketByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if OddsMarketByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of OddsMarketByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OddsMarketByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
