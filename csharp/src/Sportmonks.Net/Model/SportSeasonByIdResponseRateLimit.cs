...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSeasonByIdResponse_rate_limit")]
    public partial class SportSeasonByIdResponseRateLimit : IEquatable<SportSeasonByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSeasonByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportSeasonByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSeasonByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportSeasonByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportSeasonByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSeasonByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSeasonByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
