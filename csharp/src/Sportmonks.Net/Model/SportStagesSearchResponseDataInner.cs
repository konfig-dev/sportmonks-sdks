...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStagesSearchResponse_data_inner")]
    public partial class SportStagesSearchResponseDataInner : IEquatable<SportStagesSearchResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStagesSearchResponseDataInner" /> class.
        /// </summary>
        ...
        public SportStagesSearchResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal leagueId = default(decimal), decimal seasonId = default(decimal), decimal typeId = default(decimal), string name = default(string), SportStagesSearchResponseDataInnerSortOrder sortOrder = default(SportStagesSearchResponseDataInnerSortOrder), bool finished = default(bool), bool isCurrent = default(bool), string startingAt = default(string), string endingAt = default(string))
        {
            this.Id = id;
        ...
        public SportStagesSearchResponseDataInnerSortOrder SortOrder { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStagesSearchResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportStagesSearchResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportStagesSearchResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStagesSearchResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStagesSearchResponseDataInner input)
        {
            if (input == null)
            {
                return false;
