...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStateByIdResponse_rate_limit")]
    public partial class SportStateByIdResponseRateLimit : IEquatable<SportStateByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStateByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStateByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStateByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStateByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStateByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStateByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStateByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
