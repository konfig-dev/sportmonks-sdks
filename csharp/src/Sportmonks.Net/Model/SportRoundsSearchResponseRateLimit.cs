...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRoundsSearchResponse_rate_limit")]
    public partial class SportRoundsSearchResponseRateLimit : IEquatable<SportRoundsSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRoundsSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportRoundsSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRoundsSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportRoundsSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportRoundsSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRoundsSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRoundsSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
