...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStandingsAllResponse_rate_limit")]
    public partial class SportStandingsAllResponseRateLimit : IEquatable<SportStandingsAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStandingsAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStandingsAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStandingsAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStandingsAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStandingsAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStandingsAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStandingsAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
