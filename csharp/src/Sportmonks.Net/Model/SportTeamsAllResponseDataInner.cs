...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTeamsAllResponse_data_inner")]
    public partial class SportTeamsAllResponseDataInner : IEquatable<SportTeamsAllResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTeamsAllResponseDataInner" /> class.
        /// </summary>
        ...
        public SportTeamsAllResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), decimal venueId = default(decimal), string gender = default(string), string name = default(string), string shortCode = default(string), string imagePath = default(string), decimal founded = default(decimal), string type = default(string), bool placeholder = default(bool), string lastPlayedAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTeamsAllResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportTeamsAllResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportTeamsAllResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTeamsAllResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTeamsAllResponseDataInner input)
        {
            if (input == null)
            {
                return false;
