...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTransfersByPlayerIdResponse_rate_limit")]
    public partial class SportTransfersByPlayerIdResponseRateLimit : IEquatable<SportTransfersByPlayerIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTransfersByPlayerIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTransfersByPlayerIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTransfersByPlayerIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTransfersByPlayerIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTransfersByPlayerIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTransfersByPlayerIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTransfersByPlayerIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
