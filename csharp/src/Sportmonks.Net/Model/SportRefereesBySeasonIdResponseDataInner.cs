...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRefereesBySeasonIdResponse_data_inner")]
    public partial class SportRefereesBySeasonIdResponseDataInner : IEquatable<SportRefereesBySeasonIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRefereesBySeasonIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportRefereesBySeasonIdResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string cityId = default(string), string commonName = default(string), string firstname = default(string), string lastname = default(string), string name = default(string), string displayName = default(string), string imagePath = default(string), string height = default(string), string weight = default(string), string dateOfBirth = default(string), string gender = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRefereesBySeasonIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportRefereesBySeasonIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportRefereesBySeasonIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRefereesBySeasonIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRefereesBySeasonIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
