...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStagesAllResponse_rate_limit")]
    public partial class SportStagesAllResponseRateLimit : IEquatable<SportStagesAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStagesAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStagesAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStagesAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStagesAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStagesAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStagesAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStagesAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
