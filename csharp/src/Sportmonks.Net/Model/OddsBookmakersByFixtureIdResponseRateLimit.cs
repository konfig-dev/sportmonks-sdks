...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OddsBookmakersByFixtureIdResponse_rate_limit")]
    public partial class OddsBookmakersByFixtureIdResponseRateLimit : IEquatable<OddsBookmakersByFixtureIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OddsBookmakersByFixtureIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public OddsBookmakersByFixtureIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OddsBookmakersByFixtureIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as OddsBookmakersByFixtureIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if OddsBookmakersByFixtureIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of OddsBookmakersByFixtureIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OddsBookmakersByFixtureIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
