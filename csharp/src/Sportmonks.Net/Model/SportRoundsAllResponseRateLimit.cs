...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRoundsAllResponse_rate_limit")]
    public partial class SportRoundsAllResponseRateLimit : IEquatable<SportRoundsAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRoundsAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportRoundsAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRoundsAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportRoundsAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportRoundsAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRoundsAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRoundsAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
