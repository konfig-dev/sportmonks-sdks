...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTransfersByPlayerIdResponse_data_inner")]
    public partial class SportTransfersByPlayerIdResponseDataInner : IEquatable<SportTransfersByPlayerIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTransfersByPlayerIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportTransfersByPlayerIdResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal playerId = default(decimal), decimal typeId = default(decimal), decimal fromTeamId = default(decimal), decimal toTeamId = default(decimal), decimal positionId = default(decimal), decimal detailedPositionId = default(decimal), string date = default(string), bool careerEnded = default(bool), bool completed = default(bool), string completedAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTransfersByPlayerIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportTransfersByPlayerIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportTransfersByPlayerIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTransfersByPlayerIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTransfersByPlayerIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
