...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSeasonsSearchResponse_rate_limit")]
    public partial class SportSeasonsSearchResponseRateLimit : IEquatable<SportSeasonsSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSeasonsSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportSeasonsSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSeasonsSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportSeasonsSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportSeasonsSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSeasonsSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSeasonsSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
