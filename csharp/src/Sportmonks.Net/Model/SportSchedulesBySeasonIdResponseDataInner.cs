...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesBySeasonIdResponse_data_inner")]
    public partial class SportSchedulesBySeasonIdResponseDataInner : IEquatable<SportSchedulesBySeasonIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesBySeasonIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportSchedulesBySeasonIdResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal leagueId = default(decimal), decimal seasonId = default(decimal), decimal typeId = default(decimal), string name = default(string), decimal sortOrder = default(decimal), bool finished = default(bool), bool isCurrent = default(bool), string startingAt = default(string), string endingAt = default(string), List<SportSchedulesBySeasonIdResponseDataInnerRoundsInner> rounds = default(List<SportSchedulesBySeasonIdResponseDataInnerRoundsInner>), List<string> aggregates = default(List<string>))
        {
            this.Id = id;
        ...
        public List<SportSchedulesBySeasonIdResponseDataInnerRoundsInner> Rounds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesBySeasonIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportSchedulesBySeasonIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportSchedulesBySeasonIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesBySeasonIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesBySeasonIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
