...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportOddsPreMatchByFixtureAndMarketIdResponse_rate_limit")]
    public partial class SportOddsPreMatchByFixtureAndMarketIdResponseRateLimit : IEquatable<SportOddsPreMatchByFixtureAndMarketIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportOddsPreMatchByFixtureAndMarketIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportOddsPreMatchByFixtureAndMarketIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportOddsPreMatchByFixtureAndMarketIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportOddsPreMatchByFixtureAndMarketIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportOddsPreMatchByFixtureAndMarketIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportOddsPreMatchByFixtureAndMarketIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportOddsPreMatchByFixtureAndMarketIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
