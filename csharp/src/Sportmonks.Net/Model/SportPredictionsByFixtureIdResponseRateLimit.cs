...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportPredictionsByFixtureIdResponse_rate_limit")]
    public partial class SportPredictionsByFixtureIdResponseRateLimit : IEquatable<SportPredictionsByFixtureIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportPredictionsByFixtureIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportPredictionsByFixtureIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportPredictionsByFixtureIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportPredictionsByFixtureIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportPredictionsByFixtureIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportPredictionsByFixtureIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportPredictionsByFixtureIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
