...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLivescoresAllResponse_rate_limit")]
    public partial class SportLivescoresAllResponseRateLimit : IEquatable<SportLivescoresAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLivescoresAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportLivescoresAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLivescoresAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportLivescoresAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportLivescoresAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLivescoresAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLivescoresAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
