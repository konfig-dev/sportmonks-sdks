...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStatesBySportResponse_data_inner")]
    public partial class SportStatesBySportResponseDataInner : IEquatable<SportStatesBySportResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStatesBySportResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStatesBySportResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportStatesBySportResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportStatesBySportResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStatesBySportResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStatesBySportResponseDataInner input)
        {
            if (input == null)
            {
                return false;
