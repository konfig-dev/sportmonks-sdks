...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRoundsAllResponse_data_inner")]
    public partial class SportRoundsAllResponseDataInner : IEquatable<SportRoundsAllResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRoundsAllResponseDataInner" /> class.
        /// </summary>
        ...
        public SportRoundsAllResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal leagueId = default(decimal), decimal seasonId = default(decimal), decimal stageId = default(decimal), string name = default(string), bool finished = default(bool), bool isCurrent = default(bool), string startingAt = default(string), string endingAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRoundsAllResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportRoundsAllResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportRoundsAllResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRoundsAllResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRoundsAllResponseDataInner input)
        {
            if (input == null)
            {
                return false;
