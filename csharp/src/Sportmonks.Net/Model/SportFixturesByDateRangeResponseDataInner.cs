...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixturesByDateRangeResponse_data_inner")]
    public partial class SportFixturesByDateRangeResponseDataInner : IEquatable<SportFixturesByDateRangeResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixturesByDateRangeResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixturesByDateRangeResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportFixturesByDateRangeResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportFixturesByDateRangeResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixturesByDateRangeResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixturesByDateRangeResponseDataInner input)
        {
            if (input == null)
            {
                return false;
