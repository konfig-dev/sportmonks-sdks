...
namespace Sportmonks.Net.Model
{
    ...
    public partial class SportCoachesByCountryIdResponseDataInner : IEquatable<SportCoachesByCountryIdResponseDataInner>, IValidatableObject
    {
        ...
        public SportCoachesByCountryIdResponseDataInner(decimal id = default(decimal), decimal playerId = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string nationalityId = default(string), string cityId = default(string), string commonName = default(string), string firstname = default(string), string lastname = default(string), string name = default(string), string displayName = default(string), string imagePath = default(string), decimal? height = default(decimal?), decimal? weight = default(decimal?), string dateOfBirth = default(string), string gender = default(string))
        {
            this.Id = id;
