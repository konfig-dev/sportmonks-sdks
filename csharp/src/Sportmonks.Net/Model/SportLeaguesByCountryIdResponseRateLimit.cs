...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeaguesByCountryIdResponse_rate_limit")]
    public partial class SportLeaguesByCountryIdResponseRateLimit : IEquatable<SportLeaguesByCountryIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeaguesByCountryIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportLeaguesByCountryIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeaguesByCountryIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportLeaguesByCountryIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportLeaguesByCountryIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeaguesByCountryIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeaguesByCountryIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
