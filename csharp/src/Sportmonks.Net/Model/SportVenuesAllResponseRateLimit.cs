...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportVenuesAllResponse_rate_limit")]
    public partial class SportVenuesAllResponseRateLimit : IEquatable<SportVenuesAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportVenuesAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportVenuesAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportVenuesAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportVenuesAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportVenuesAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportVenuesAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportVenuesAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
