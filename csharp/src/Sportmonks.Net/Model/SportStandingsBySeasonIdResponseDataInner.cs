...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStandingsBySeasonIdResponse_data_inner")]
    public partial class SportStandingsBySeasonIdResponseDataInner : IEquatable<SportStandingsBySeasonIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStandingsBySeasonIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportStandingsBySeasonIdResponseDataInner(decimal id = default(decimal), decimal participantId = default(decimal), decimal sportId = default(decimal), decimal leagueId = default(decimal), decimal seasonId = default(decimal), decimal stageId = default(decimal), string groupId = default(string), decimal roundId = default(decimal), decimal standingRuleId = default(decimal), decimal position = default(decimal), string result = default(string), decimal points = default(decimal))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStandingsBySeasonIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportStandingsBySeasonIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportStandingsBySeasonIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStandingsBySeasonIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStandingsBySeasonIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
