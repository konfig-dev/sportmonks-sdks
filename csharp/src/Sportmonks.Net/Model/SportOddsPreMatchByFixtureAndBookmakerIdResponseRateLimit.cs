...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportOddsPreMatchByFixtureAndBookmakerIdResponse_rate_limit")]
    public partial class SportOddsPreMatchByFixtureAndBookmakerIdResponseRateLimit : IEquatable<SportOddsPreMatchByFixtureAndBookmakerIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportOddsPreMatchByFixtureAndBookmakerIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportOddsPreMatchByFixtureAndBookmakerIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportOddsPreMatchByFixtureAndBookmakerIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportOddsPreMatchByFixtureAndBookmakerIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportOddsPreMatchByFixtureAndBookmakerIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportOddsPreMatchByFixtureAndBookmakerIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportOddsPreMatchByFixtureAndBookmakerIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
