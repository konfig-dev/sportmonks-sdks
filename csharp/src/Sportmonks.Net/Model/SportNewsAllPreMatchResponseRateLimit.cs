...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportNewsAllPreMatchResponse_rate_limit")]
    public partial class SportNewsAllPreMatchResponseRateLimit : IEquatable<SportNewsAllPreMatchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportNewsAllPreMatchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportNewsAllPreMatchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportNewsAllPreMatchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportNewsAllPreMatchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportNewsAllPreMatchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportNewsAllPreMatchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportNewsAllPreMatchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
