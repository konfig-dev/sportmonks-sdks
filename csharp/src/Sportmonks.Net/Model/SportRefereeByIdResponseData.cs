...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRefereeByIdResponse_data")]
    public partial class SportRefereeByIdResponseData : IEquatable<SportRefereeByIdResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRefereeByIdResponseData" /> class.
        /// </summary>
        ...
        public SportRefereeByIdResponseData(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string cityId = default(string), string commonName = default(string), string firstname = default(string), string lastname = default(string), string name = default(string), string displayName = default(string), string imagePath = default(string), string height = default(string), string weight = default(string), string dateOfBirth = default(string), string gender = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRefereeByIdResponseData {\n");
        ...
        {
            return this.Equals(input as SportRefereeByIdResponseData);
        }

        /// <summary>
        /// Returns true if SportRefereeByIdResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRefereeByIdResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRefereeByIdResponseData input)
        {
            if (input == null)
            {
                return false;
