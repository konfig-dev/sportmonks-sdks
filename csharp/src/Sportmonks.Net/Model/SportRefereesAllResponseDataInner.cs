...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRefereesAllResponse_data_inner")]
    public partial class SportRefereesAllResponseDataInner : IEquatable<SportRefereesAllResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRefereesAllResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRefereesAllResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportRefereesAllResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportRefereesAllResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRefereesAllResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRefereesAllResponseDataInner input)
        {
            if (input == null)
            {
                return false;
