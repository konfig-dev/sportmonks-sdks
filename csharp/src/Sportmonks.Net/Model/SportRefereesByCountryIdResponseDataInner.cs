...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRefereesByCountryIdResponse_data_inner")]
    public partial class SportRefereesByCountryIdResponseDataInner : IEquatable<SportRefereesByCountryIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRefereesByCountryIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportRefereesByCountryIdResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string cityId = default(string), string commonName = default(string), string firstname = default(string), string lastname = default(string), string name = default(string), string displayName = default(string), string imagePath = default(string), string height = default(string), string weight = default(string), string dateOfBirth = default(string), string gender = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRefereesByCountryIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportRefereesByCountryIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportRefereesByCountryIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRefereesByCountryIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRefereesByCountryIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
