...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportOddsPreMatchByFixtureIdResponse_data_inner")]
    public partial class SportOddsPreMatchByFixtureIdResponseDataInner : IEquatable<SportOddsPreMatchByFixtureIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportOddsPreMatchByFixtureIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportOddsPreMatchByFixtureIdResponseDataInnerWinning Winning { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportOddsPreMatchByFixtureIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportOddsPreMatchByFixtureIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportOddsPreMatchByFixtureIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportOddsPreMatchByFixtureIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportOddsPreMatchByFixtureIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
