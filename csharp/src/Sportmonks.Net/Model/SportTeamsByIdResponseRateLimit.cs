...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTeamsByIdResponse_rate_limit")]
    public partial class SportTeamsByIdResponseRateLimit : IEquatable<SportTeamsByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTeamsByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTeamsByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTeamsByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTeamsByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTeamsByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTeamsByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTeamsByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
