...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportCommentariesAllResponse_rate_limit")]
    public partial class SportCommentariesAllResponseRateLimit : IEquatable<SportCommentariesAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportCommentariesAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportCommentariesAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportCommentariesAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportCommentariesAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportCommentariesAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportCommentariesAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportCommentariesAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
