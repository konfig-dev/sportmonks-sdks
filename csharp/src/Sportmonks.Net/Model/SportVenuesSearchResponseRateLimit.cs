...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportVenuesSearchResponse_rate_limit")]
    public partial class SportVenuesSearchResponseRateLimit : IEquatable<SportVenuesSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportVenuesSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportVenuesSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportVenuesSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportVenuesSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportVenuesSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportVenuesSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportVenuesSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
