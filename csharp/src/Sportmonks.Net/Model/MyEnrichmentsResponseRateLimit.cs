...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MyEnrichmentsResponse_rate_limit")]
    public partial class MyEnrichmentsResponseRateLimit : IEquatable<MyEnrichmentsResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MyEnrichmentsResponseRateLimit" /> class.
        /// </summary>
        ...
        public MyEnrichmentsResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MyEnrichmentsResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as MyEnrichmentsResponseRateLimit);
        }

        /// <summary>
        /// Returns true if MyEnrichmentsResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of MyEnrichmentsResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MyEnrichmentsResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
