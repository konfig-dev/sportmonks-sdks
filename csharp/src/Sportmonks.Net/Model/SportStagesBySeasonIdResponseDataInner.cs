...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStagesBySeasonIdResponse_data_inner")]
    public partial class SportStagesBySeasonIdResponseDataInner : IEquatable<SportStagesBySeasonIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStagesBySeasonIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportStagesBySeasonIdResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal leagueId = default(decimal), decimal seasonId = default(decimal), decimal typeId = default(decimal), string name = default(string), decimal sortOrder = default(decimal), bool finished = default(bool), bool isCurrent = default(bool), string startingAt = default(string), string endingAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStagesBySeasonIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportStagesBySeasonIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportStagesBySeasonIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStagesBySeasonIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStagesBySeasonIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
