...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TypesAllResponse_rate_limit")]
    public partial class TypesAllResponseRateLimit : IEquatable<TypesAllResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TypesAllResponseRateLimit" /> class.
        /// </summary>
        ...
        public TypesAllResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TypesAllResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as TypesAllResponseRateLimit);
        }

        /// <summary>
        /// Returns true if TypesAllResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of TypesAllResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TypesAllResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
