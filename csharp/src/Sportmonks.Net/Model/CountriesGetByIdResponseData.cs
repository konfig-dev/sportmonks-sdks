...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CountriesGetByIdResponse_data")]
    public partial class CountriesGetByIdResponseData : IEquatable<CountriesGetByIdResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountriesGetByIdResponseData" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CountriesGetByIdResponseData {\n");
        ...
        {
            return this.Equals(input as CountriesGetByIdResponseData);
        }

        /// <summary>
        /// Returns true if CountriesGetByIdResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of CountriesGetByIdResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountriesGetByIdResponseData input)
        {
            if (input == null)
            {
                return false;
