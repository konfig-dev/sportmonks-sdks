...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRefereesSearchResponse_data_inner")]
    public partial class SportRefereesSearchResponseDataInner : IEquatable<SportRefereesSearchResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRefereesSearchResponseDataInner" /> class.
        /// </summary>
        ...
        public SportRefereesSearchResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string cityId = default(string), string commonName = default(string), string firstname = default(string), string lastname = default(string), string name = default(string), string displayName = default(string), string imagePath = default(string), string height = default(string), string weight = default(string), string dateOfBirth = default(string), string gender = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRefereesSearchResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportRefereesSearchResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportRefereesSearchResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRefereesSearchResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRefereesSearchResponseDataInner input)
        {
            if (input == null)
            {
                return false;
