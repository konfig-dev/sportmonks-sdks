...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportCoachByIdResponse_rate_limit")]
    public partial class SportCoachByIdResponseRateLimit : IEquatable<SportCoachByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportCoachByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportCoachByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportCoachByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportCoachByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportCoachByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportCoachByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportCoachByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
