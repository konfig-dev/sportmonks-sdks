...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStagesSearchResponse_rate_limit")]
    public partial class SportStagesSearchResponseRateLimit : IEquatable<SportStagesSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStagesSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStagesSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStagesSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStagesSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStagesSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStagesSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStagesSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
