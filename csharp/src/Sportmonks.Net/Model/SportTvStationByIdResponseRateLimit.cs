...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTvStationByIdResponse_rate_limit")]
    public partial class SportTvStationByIdResponseRateLimit : IEquatable<SportTvStationByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTvStationByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTvStationByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTvStationByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTvStationByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTvStationByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTvStationByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTvStationByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
