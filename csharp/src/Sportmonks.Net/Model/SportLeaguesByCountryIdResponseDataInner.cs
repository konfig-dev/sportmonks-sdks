...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeaguesByCountryIdResponse_data_inner")]
    public partial class SportLeaguesByCountryIdResponseDataInner : IEquatable<SportLeaguesByCountryIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeaguesByCountryIdResponseDataInner" /> class.
        /// </summary>
        ...
        public SportLeaguesByCountryIdResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string name = default(string), bool active = default(bool), string shortCode = default(string), string imagePath = default(string), string type = default(string), string subType = default(string), string lastPlayedAt = default(string), decimal category = default(decimal), bool hasJerseys = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeaguesByCountryIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportLeaguesByCountryIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportLeaguesByCountryIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeaguesByCountryIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeaguesByCountryIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
