...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesByTeamAndSeasonIdResponse_rate_limit")]
    public partial class SportSchedulesByTeamAndSeasonIdResponseRateLimit : IEquatable<SportSchedulesByTeamAndSeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesByTeamAndSeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportSchedulesByTeamAndSeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesByTeamAndSeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportSchedulesByTeamAndSeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportSchedulesByTeamAndSeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesByTeamAndSeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesByTeamAndSeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
