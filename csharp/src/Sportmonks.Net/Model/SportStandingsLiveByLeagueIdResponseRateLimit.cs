...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStandingsLiveByLeagueIdResponse_rate_limit")]
    public partial class SportStandingsLiveByLeagueIdResponseRateLimit : IEquatable<SportStandingsLiveByLeagueIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStandingsLiveByLeagueIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStandingsLiveByLeagueIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStandingsLiveByLeagueIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStandingsLiveByLeagueIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStandingsLiveByLeagueIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStandingsLiveByLeagueIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStandingsLiveByLeagueIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
