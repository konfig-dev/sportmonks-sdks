...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStageByIdResponse_data")]
    public partial class SportStageByIdResponseData : IEquatable<SportStageByIdResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStageByIdResponseData" /> class.
        /// </summary>
        ...
        public SportStageByIdResponseData(decimal id = default(decimal), decimal sportId = default(decimal), decimal leagueId = default(decimal), decimal seasonId = default(decimal), decimal typeId = default(decimal), string name = default(string), string sortOrder = default(string), bool finished = default(bool), bool isCurrent = default(bool), string startingAt = default(string), string endingAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStageByIdResponseData {\n");
        ...
        {
            return this.Equals(input as SportStageByIdResponseData);
        }

        /// <summary>
        /// Returns true if SportStageByIdResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStageByIdResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStageByIdResponseData input)
        {
            if (input == null)
            {
                return false;
