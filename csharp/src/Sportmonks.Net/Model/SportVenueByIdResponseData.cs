...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportVenueByIdResponse_data")]
    public partial class SportVenueByIdResponseData : IEquatable<SportVenueByIdResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportVenueByIdResponseData" /> class.
        /// </summary>
        ...
        public SportVenueByIdResponseData(decimal id = default(decimal), decimal countryId = default(decimal), decimal cityId = default(decimal), string name = default(string), string address = default(string), string zipcode = default(string), string latitude = default(string), string longitude = default(string), decimal capacity = default(decimal), string imagePath = default(string), string cityName = default(string), string surface = default(string), bool nationalTeam = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportVenueByIdResponseData {\n");
        ...
        {
            return this.Equals(input as SportVenueByIdResponseData);
        }

        /// <summary>
        /// Returns true if SportVenueByIdResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of SportVenueByIdResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportVenueByIdResponseData input)
        {
            if (input == null)
            {
                return false;
