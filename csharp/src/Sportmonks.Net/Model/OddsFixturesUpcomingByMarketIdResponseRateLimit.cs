...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OddsFixturesUpcomingByMarketIdResponse_rate_limit")]
    public partial class OddsFixturesUpcomingByMarketIdResponseRateLimit : IEquatable<OddsFixturesUpcomingByMarketIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OddsFixturesUpcomingByMarketIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public OddsFixturesUpcomingByMarketIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OddsFixturesUpcomingByMarketIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as OddsFixturesUpcomingByMarketIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if OddsFixturesUpcomingByMarketIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of OddsFixturesUpcomingByMarketIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OddsFixturesUpcomingByMarketIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
