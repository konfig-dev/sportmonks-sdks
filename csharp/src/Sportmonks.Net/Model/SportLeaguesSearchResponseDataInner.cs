...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeaguesSearchResponse_data_inner")]
    public partial class SportLeaguesSearchResponseDataInner : IEquatable<SportLeaguesSearchResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeaguesSearchResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeaguesSearchResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportLeaguesSearchResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportLeaguesSearchResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeaguesSearchResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeaguesSearchResponseDataInner input)
        {
            if (input == null)
            {
                return false;
