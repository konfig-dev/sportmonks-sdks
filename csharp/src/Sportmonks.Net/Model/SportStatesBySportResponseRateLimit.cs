...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportStatesBySportResponse_rate_limit")]
    public partial class SportStatesBySportResponseRateLimit : IEquatable<SportStatesBySportResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportStatesBySportResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportStatesBySportResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportStatesBySportResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportStatesBySportResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportStatesBySportResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportStatesBySportResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportStatesBySportResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
