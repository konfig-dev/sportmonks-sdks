...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixturesSearchResponse_rate_limit")]
    public partial class SportFixturesSearchResponseRateLimit : IEquatable<SportFixturesSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixturesSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportFixturesSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixturesSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportFixturesSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportFixturesSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixturesSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixturesSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
