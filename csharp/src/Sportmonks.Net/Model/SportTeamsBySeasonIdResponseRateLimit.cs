...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTeamsBySeasonIdResponse_rate_limit")]
    public partial class SportTeamsBySeasonIdResponseRateLimit : IEquatable<SportTeamsBySeasonIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTeamsBySeasonIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTeamsBySeasonIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTeamsBySeasonIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTeamsBySeasonIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTeamsBySeasonIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTeamsBySeasonIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTeamsBySeasonIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
