...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MyLeaguesResponse_data_inner")]
    public partial class MyLeaguesResponseDataInner : IEquatable<MyLeaguesResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MyLeaguesResponseDataInner" /> class.
        /// </summary>
        ...
        public MyLeaguesResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal countryId = default(decimal), string name = default(string), bool active = default(bool), string shortCode = default(string), string imagePath = default(string), string type = default(string), string subType = default(string), string lastPlayedAt = default(string), decimal category = default(decimal), bool hasJerseys = default(bool), MyLeaguesResponseDataInnerSport sport = default(MyLeaguesResponseDataInnerSport))
        {
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name = "last_played_at", EmitDefaultValue = true)]
        ...
        public MyLeaguesResponseDataInnerSport Sport { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MyLeaguesResponseDataInner {\n");
        ...
        {
            return this.Equals(input as MyLeaguesResponseDataInner);
        }

        /// <summary>
        /// Returns true if MyLeaguesResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of MyLeaguesResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MyLeaguesResponseDataInner input)
        {
            if (input == null)
            {
                return false;
