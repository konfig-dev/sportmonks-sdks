...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportOddsAllInPlayResponse_data_inner")]
    public partial class SportOddsAllInPlayResponseDataInner : IEquatable<SportOddsAllInPlayResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportOddsAllInPlayResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportOddsAllInPlayResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportOddsAllInPlayResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportOddsAllInPlayResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportOddsAllInPlayResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportOddsAllInPlayResponseDataInner input)
        {
            if (input == null)
            {
                return false;
