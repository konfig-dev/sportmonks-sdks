...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSchedulesBySeasonIdResponse_data_inner_rounds_inner_fixtures_inner")]
    public partial class SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner : IEquatable<SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner" /> class.
        /// </summary>
        ...
        public List<SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInnerParticipantsInner> Participants { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner {\n");
        ...
        {
            return this.Equals(input as SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner);
        }

        /// <summary>
        /// Returns true if SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSchedulesBySeasonIdResponseDataInnerRoundsInnerFixturesInner input)
        {
            if (input == null)
            {
                return false;
