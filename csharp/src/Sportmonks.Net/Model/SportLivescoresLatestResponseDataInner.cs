...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLivescoresLatestResponse_data_inner")]
    public partial class SportLivescoresLatestResponseDataInner : IEquatable<SportLivescoresLatestResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLivescoresLatestResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLivescoresLatestResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportLivescoresLatestResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportLivescoresLatestResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLivescoresLatestResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLivescoresLatestResponseDataInner input)
        {
            if (input == null)
            {
                return false;
