...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixturesByIdsResponse_rate_limit")]
    public partial class SportFixturesByIdsResponseRateLimit : IEquatable<SportFixturesByIdsResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixturesByIdsResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportFixturesByIdsResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixturesByIdsResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportFixturesByIdsResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportFixturesByIdsResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixturesByIdsResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixturesByIdsResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
