...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportSeasonByIdResponse_data")]
    public partial class SportSeasonByIdResponseData : IEquatable<SportSeasonByIdResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportSeasonByIdResponseData" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportSeasonByIdResponseData {\n");
        ...
        {
            return this.Equals(input as SportSeasonByIdResponseData);
        }

        /// <summary>
        /// Returns true if SportSeasonByIdResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of SportSeasonByIdResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportSeasonByIdResponseData input)
        {
            if (input == null)
            {
                return false;
