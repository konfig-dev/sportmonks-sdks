...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportTeamsSearchResponse_rate_limit")]
    public partial class SportTeamsSearchResponseRateLimit : IEquatable<SportTeamsSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportTeamsSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportTeamsSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportTeamsSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportTeamsSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportTeamsSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportTeamsSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportTeamsSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
