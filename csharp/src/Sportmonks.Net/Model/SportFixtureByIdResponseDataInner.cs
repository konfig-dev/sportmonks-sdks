...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportFixtureByIdResponse_data_inner")]
    public partial class SportFixtureByIdResponseDataInner : IEquatable<SportFixtureByIdResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportFixtureByIdResponseDataInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportFixtureByIdResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportFixtureByIdResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportFixtureByIdResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportFixtureByIdResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportFixtureByIdResponseDataInner input)
        {
            if (input == null)
            {
                return false;
