...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OddsBookmakerByIdResponse_rate_limit")]
    public partial class OddsBookmakerByIdResponseRateLimit : IEquatable<OddsBookmakerByIdResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OddsBookmakerByIdResponseRateLimit" /> class.
        /// </summary>
        ...
        public OddsBookmakerByIdResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OddsBookmakerByIdResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as OddsBookmakerByIdResponseRateLimit);
        }

        /// <summary>
        /// Returns true if OddsBookmakerByIdResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of OddsBookmakerByIdResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OddsBookmakerByIdResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
