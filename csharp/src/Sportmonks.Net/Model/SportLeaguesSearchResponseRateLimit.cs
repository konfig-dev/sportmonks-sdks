...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportLeaguesSearchResponse_rate_limit")]
    public partial class SportLeaguesSearchResponseRateLimit : IEquatable<SportLeaguesSearchResponseRateLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportLeaguesSearchResponseRateLimit" /> class.
        /// </summary>
        ...
        public SportLeaguesSearchResponseRateLimit(decimal resetsInSeconds = default(decimal), decimal remaining = default(decimal), string requestedEntity = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportLeaguesSearchResponseRateLimit {\n");
        ...
        {
            return this.Equals(input as SportLeaguesSearchResponseRateLimit);
        }

        /// <summary>
        /// Returns true if SportLeaguesSearchResponseRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of SportLeaguesSearchResponseRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportLeaguesSearchResponseRateLimit input)
        {
            if (input == null)
            {
                return false;
