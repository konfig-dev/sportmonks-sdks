...
namespace Sportmonks.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SportRoundsSearchResponse_data_inner")]
    public partial class SportRoundsSearchResponseDataInner : IEquatable<SportRoundsSearchResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportRoundsSearchResponseDataInner" /> class.
        /// </summary>
        ...
        public SportRoundsSearchResponseDataInner(decimal id = default(decimal), decimal sportId = default(decimal), decimal leagueId = default(decimal), decimal seasonId = default(decimal), decimal stageId = default(decimal), string name = default(string), bool finished = default(bool), bool isCurrent = default(bool), string startingAt = default(string), string endingAt = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SportRoundsSearchResponseDataInner {\n");
        ...
        {
            return this.Equals(input as SportRoundsSearchResponseDataInner);
        }

        /// <summary>
        /// Returns true if SportRoundsSearchResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SportRoundsSearchResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SportRoundsSearchResponseDataInner input)
        {
            if (input == null)
            {
                return false;
