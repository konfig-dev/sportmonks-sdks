...
class RequiredSportFixturesHeadToHeadResponseDataItem(TypedDict):
    pass

class OptionalSportFixturesHeadToHeadResponseDataItem(TypedDict, total=False):
...
class SportFixturesHeadToHeadResponseDataItem(RequiredSportFixturesHeadToHeadResponseDataItem, OptionalSportFixturesHeadToHeadResponseDataItem):
    pass
