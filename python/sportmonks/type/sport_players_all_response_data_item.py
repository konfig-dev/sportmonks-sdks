...
class RequiredSportPlayersAllResponseDataItem(TypedDict):
    pass

class OptionalSportPlayersAllResponseDataItem(TypedDict, total=False):
...
class SportPlayersAllResponseDataItem(RequiredSportPlayersAllResponseDataItem, OptionalSportPlayersAllResponseDataItem):
    pass
