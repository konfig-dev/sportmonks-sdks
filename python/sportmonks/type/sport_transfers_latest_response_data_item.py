...
class RequiredSportTransfersLatestResponseDataItem(TypedDict):
    pass

class OptionalSportTransfersLatestResponseDataItem(TypedDict, total=False):
...
class SportTransfersLatestResponseDataItem(RequiredSportTransfersLatestResponseDataItem, OptionalSportTransfersLatestResponseDataItem):
    pass
