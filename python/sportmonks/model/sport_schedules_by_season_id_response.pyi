...
class SportSchedulesBySeasonIdResponse(
    schemas.DictSchema
):
    """
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sport_id", "league_id", "season_id", "type_id", "name", "sort_order", "finished", "is_current", "starting_at", "ending_at", "rounds", "aggregates", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sport_id", "league_id", "season_id", "type_id", "name", "sort_order", "finished", "is_current", "starting_at", "ending_at", "rounds", "aggregates", ], str]):
                            return super().get_item_oapg(name)
