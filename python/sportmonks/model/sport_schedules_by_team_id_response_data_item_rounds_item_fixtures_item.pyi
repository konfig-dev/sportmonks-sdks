...
class SportSchedulesByTeamIdResponseDataItemRoundsItemFixturesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def participants() -> typing.Type['SportSchedulesByTeamIdResponseDataItemRoundsItemFixturesItemParticipants']:
                return SportSchedulesByTeamIdResponseDataItemRoundsItemFixturesItemParticipants
            __annotations__ = {
                "id": id,
                "sport_id": sport_id,
                "league_id": league_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["participants"]) -> 'SportSchedulesByTeamIdResponseDataItemRoundsItemFixturesItemParticipants': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["participants"]) -> typing.Union['SportSchedulesByTeamIdResponseDataItemRoundsItemFixturesItemParticipants', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        participants: typing.Union['SportSchedulesByTeamIdResponseDataItemRoundsItemFixturesItemParticipants', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
