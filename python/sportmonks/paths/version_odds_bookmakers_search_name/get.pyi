...
from sportmonks.model.odds_bookmakers_search_response import OddsBookmakersSearchResponse as OddsBookmakersSearchResponseSchema

from sportmonks.type.odds_bookmakers_search_response import OddsBookmakersSearchResponse
...
SchemaFor0ResponseBodyApplicationJson = OddsBookmakersSearchResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: OddsBookmakersSearchResponse
...
class BaseApi(api_client.Api):
    ...
    async def _abookmakers_search_oapg(
        self,
...
class BookmakersSearch(BaseApi):
