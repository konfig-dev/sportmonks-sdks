...
from sportmonks.model.sport_predictions_all_response import SportPredictionsAllResponse as SportPredictionsAllResponseSchema

from sportmonks.type.sport_predictions_all_response import SportPredictionsAllResponse
...
SchemaFor200ResponseBodyApplicationJson = SportPredictionsAllResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: SportPredictionsAllResponse
...
class BaseApi(api_client.Api):
    ...
    def _predictions_all_mapped_args(
        self,
        version: str,
        sport: str,
    ...
    async def _apredictions_all_oapg(
        self,
...
class PredictionsAll(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apredictions_all(
        self,
        version: str,
        sport: str,
    ) -> typing.Union[
        ...
        args = self._predictions_all_mapped_args(
            version=version,
            sport=sport,
        )
        return await self._apredictions_all_oapg(
    ...
    def predictions_all(
        ...
        return self._predictions_all_oapg(
            path_params=args.path,
        )
