...
class BaseApi(api_client.Api):
    ...
    def _leagues_by_team_id_mapped_args(
        self,
        version: str,
        sport: str,
        team_id: int,
    ...
    async def _aleagues_by_team_id_oapg(
        self,
...
class LeaguesByTeamId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aleagues_by_team_id(
        self,
        version: str,
        sport: str,
        team_id: int,
        ...
        args = self._leagues_by_team_id_mapped_args(
            version=version,
            sport=sport,
            team_id=team_id,
        )
        return await self._aleagues_by_team_id_oapg(
            path_params=args.path,
        )
    
    def leagues_by_team_id(
        self,
        version: str,
        sport: str,
        team_id: int,
        ...
        return self._leagues_by_team_id_oapg(
            path_params=args.path,
        )
