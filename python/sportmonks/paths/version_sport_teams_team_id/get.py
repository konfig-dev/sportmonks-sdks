...
from sportmonks.model.sport_teams_by_id_response import SportTeamsByIdResponse as SportTeamsByIdResponseSchema

from sportmonks.type.sport_teams_by_id_response import SportTeamsByIdResponse
...
SchemaFor0ResponseBodyApplicationJson = SportTeamsByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportTeamsByIdResponse
...
class TeamsById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ateams_by_id(
        self,
        version: str,
        sport: str,
        team_id: int,
        ...
        args = self._teams_by_id_mapped_args(
            version=version,
            sport=sport,
            team_id=team_id,
        )
        return await self._ateams_by_id_oapg(
