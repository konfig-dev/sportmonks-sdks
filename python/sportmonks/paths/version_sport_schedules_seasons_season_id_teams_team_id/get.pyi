...
from sportmonks.model.sport_schedules_by_team_and_season_id_response import SportSchedulesByTeamAndSeasonIdResponse as SportSchedulesByTeamAndSeasonIdResponseSchema

from sportmonks.type.sport_schedules_by_team_and_season_id_response import SportSchedulesByTeamAndSeasonIdResponse
...
SchemaFor0ResponseBodyApplicationJson = SportSchedulesByTeamAndSeasonIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportSchedulesByTeamAndSeasonIdResponse
...
class BaseApi(api_client.Api):
    ...
    async def _aschedules_by_team_and_season_id_oapg(
        self,
    ...
    def _schedules_by_team_and_season_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class SchedulesByTeamAndSeasonId(BaseApi):
