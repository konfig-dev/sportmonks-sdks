...
from sportmonks.model.sport_league_by_id_response import SportLeagueByIdResponse as SportLeagueByIdResponseSchema

from sportmonks.type.sport_league_by_id_response import SportLeagueByIdResponse
...
SchemaFor0ResponseBodyApplicationJson = SportLeagueByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportLeagueByIdResponse
...
class LeagueById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aleague_by_id(
        self,
        version: str,
        sport: str,
        league_id: int,
        ...
        args = self._league_by_id_mapped_args(
            version=version,
            sport=sport,
            league_id=league_id,
        )
        return await self._aleague_by_id_oapg(
    ...
    def league_by_id(
        ...
        return self._league_by_id_oapg(
            path_params=args.path,
        )
