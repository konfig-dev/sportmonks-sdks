...
from sportmonks.model.countries_get_by_id_response import CountriesGetByIdResponse as CountriesGetByIdResponseSchema

from sportmonks.type.countries_get_by_id_response import CountriesGetByIdResponse
...
SchemaFor0ResponseBodyApplicationJson = CountriesGetByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: CountriesGetByIdResponse
