...
from sportmonks.model.sport_player_by_id_response import SportPlayerByIdResponse as SportPlayerByIdResponseSchema

from sportmonks.type.sport_player_by_id_response import SportPlayerByIdResponse
...
SchemaFor0ResponseBodyApplicationJson = SportPlayerByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportPlayerByIdResponse
...
class PlayerById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aplayer_by_id(
        self,
        version: str,
        sport: str,
        player_id: int,
        ...
        args = self._player_by_id_mapped_args(
            version=version,
            sport=sport,
            player_id=player_id,
        )
        return await self._aplayer_by_id_oapg(
    ...
    def player_by_id(
        ...
        return self._player_by_id_oapg(
            path_params=args.path,
        )
