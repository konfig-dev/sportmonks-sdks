...
class BaseApi(api_client.Api):
    ...
    def _odds_latest_in_play_mapped_args(
        self,
        version: str,
        sport: str,
    ...
    async def _aodds_latest_in_play_oapg(
        self,
...
class OddsLatestInPlay(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aodds_latest_in_play(
        self,
        version: str,
        sport: str,
    ) -> typing.Union[
        ...
        args = self._odds_latest_in_play_mapped_args(
            version=version,
            sport=sport,
        )
        return await self._aodds_latest_in_play_oapg(
            path_params=args.path,
        )
    
    def odds_latest_in_play(
        self,
        version: str,
        sport: str,
    ) -> typing.Union[
        ...
        return self._odds_latest_in_play_oapg(
            path_params=args.path,
        )
