...
from sportmonks.model.continents_get_by_id_response import ContinentsGetByIdResponse as ContinentsGetByIdResponseSchema

from sportmonks.type.continents_get_by_id_response import ContinentsGetByIdResponse

from . import path

# Path params
VersionSchema = schemas.StrSchema
ContinentIdSchema = schemas.IntSchema
...
request_path_continent_id = api_client.PathParameter(
    name="continentId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ContinentIdSchema,
    required=True,
)
_auth = [
    'apikeyAuth',
]
SchemaFor0ResponseBodyApplicationJson = ContinentsGetByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: ContinentsGetByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_by_id_mapped_args(
        ...
        if continent_id is not None:
            _path_params["continentId"] = continent_id
